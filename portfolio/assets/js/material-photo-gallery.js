(function e(t, n, r) {
...
})(
  {
    ...
    2: [
      ...
      { eventie: 1, "wolfy87-eventemitter": 3 },
    ],
    3: [
      function (require, module, exports) {
        /*!
        ...
        (function (root, factory) {
          ...
          Gallery.prototype._layout = function () {
            ...
            imgLoad.on("fail", function (instance) {
              ...
              alertBoxMessage.innerHTML =
                "Failed to load:" + " " + brokenImages;
            });
          ...
          Gallery.prototype._positionFullImgs = function (
            img,
            i,
            applyTransform
          ) {
          ...
          Gallery.prototype._transformFullImg = function (
            fullImg,
            thumb,
            fullImgSize
          ) {
          ...
          Gallery.prototype._closeFullImg = function () {
            var animation = function () {
              ...
              this._fullImg.style[transformString] =
                this._fullImgsTransforms[this._thumbIndex];
              ...
              var fullImgTransEnd = function () {
                ...
                this._fullImg.removeEventListener(
                  transitionendString,
                  fullImgTransEnd
                );
              ...
              this._fullImg.addEventListener(
                transitionendString,
                fullImgTransEnd
              );
              this._enableScroll();
          ...
          Gallery.prototype._changeImg = function (dir) {
            ...
            if (!this._newFullImg || this._newFullImg.nodeName !== "IMG") {
              this._newFullImg =
                dir === "next"
                  ...
                  : (this._newFullImg =
                      this._fullImgs[this._fullImgs.length - 1]);
              dir === "next"
                ? (this._thumbIndex = 0)
            ...
            this._fullImg.classList.remove("active");
            this._fullImg.style[transformString] =
              this._fullImgsTransforms[this._thumbIndex - 1];
