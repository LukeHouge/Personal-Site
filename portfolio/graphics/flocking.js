...
// setup sliders
let speedSlider = /** @type {HTMLInputElement} */ (document.getElementById(
    'speed'
));
let widthSlider = /** @type {HTMLInputElement} */ (document.getElementById(
    'width'
));
let altColorFramesSlider = /** @type {HTMLInputElement} */ (document.getElementById(
    'frames'
));
let numObstaclesSlider = /** @type {HTMLInputElement} */ (document.getElementById(
    'obstacles'
));
let alignmentSlider = /** @type {HTMLInputElement} */ (document.getElementById(
    'alignment'
));
let separationSlider = /** @type {HTMLInputElement} */ (document.getElementById(
    'separation'
));
let cohesionSlider = /** @type {HTMLInputElement} */ (document.getElementById(
    'cohesion'
));
let alignmentRangeSlider = /** @type {HTMLInputElement} */ (document.getElementById(
    'range'
));
let marginSlider = /** @type {HTMLInputElement} */ (document.getElementById(
    'margin'
));
let checkCollisionsBox = /** @type {HTMLInputElement} */ (document.getElementById(
    'checkCollisions'
));
let fpsDisplay = /** @type {HTMLInputElement} */ (document.getElementById(
    'fps'
));
let rejectionSlider = /** @type {HTMLInputElement} */ (document.getElementById(
    'rejection'
));
let minDistanceSlider = /** @type {HTMLInputElement} */ (document.getElementById(
    'minDistance'
));
