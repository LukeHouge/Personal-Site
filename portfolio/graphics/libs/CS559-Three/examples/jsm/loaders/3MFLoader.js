  ...
  parse: function (data) {
    ...
    function loadDocument(data) {
      ...
      try {
        ...
        if (e instanceof ReferenceError) {
          console.error(
            "THREE.3MFLoader: jszip missing and file is compressed."
          );
          return null;
        }
      }
      ...
      for (var i = 0; i < texturesPartNames.length; i++) {
        ...
        texturesParts[texturesPartName] = zip
    ...
    function parseTextures2DGroupNode(texture2DGroupNode) {
      var texture2DGroupData = {
        ...
        displaypropertiesid: texture2DGroupNode.getAttribute(
          "displaypropertiesid"
        ),
      };
    ...
    function parseMetallicDisplaypropertiesNode(metallicDisplaypropetiesNode) {
      ...
      var metallicNodes =
        metallicDisplaypropetiesNode.querySelectorAll("pbmetallic");
    ...
    function parseBasematerialNode(basematerialNode) {
      ...
      basematerialData["displaycolor"] =
        basematerialNode.getAttribute("displaycolor"); // required
    ...
    function parseResourcesNode(resourcesNode) {
      ...
      for (var i = 0; i < basematerialsNodes.length; i++) {
        ...
        resourcesData["basematerials"][basematerialsData["id"]] =
          basematerialsData;
      }
      ...
      for (var i = 0; i < pbmetallicdisplaypropertiesNodes.length; i++) {
        var pbmetallicdisplaypropertiesNode =
          pbmetallicdisplaypropertiesNodes[i];
        var pbmetallicdisplaypropertiesData =
          parseMetallicDisplaypropertiesNode(pbmetallicdisplaypropertiesNode);
        resourcesData["pbmetallicdisplayproperties"][
      ...
      var textures2DGroupNodes =
        resourcesNode.querySelectorAll("texture2dgroup");

      for (var i = 0; i < textures2DGroupNodes.length; i++) {
        var textures2DGroupNode = textures2DGroupNodes[i];
        var textures2DGroupData = parseTextures2DGroupNode(textures2DGroupNode);
        resourcesData["texture2dgroup"][textures2DGroupData["id"]] =
          textures2DGroupData;
      }
    ...
    function build(objects, data3mf) {
      ...
      var buildData =
        data3mf.model[relationship["target"].substring(1)]["build"];
