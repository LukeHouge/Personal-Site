  ...
  parse: function () {
    ...
    for (var name in lwoTree.materials) {
      if (lwoTree.format === "LWO3") {
        materials.push(
          this.parseMaterial(lwoTree.materials[name], name, lwoTree.textures)
        );
      } else if (lwoTree.format === "LWO2") {
        materials.push(
          this.parseMaterialLwo2(
            lwoTree.materials[name],
            name,
            lwoTree.textures
          )
        );
...
GeometryParser.prototype = {
  ...
  parseGroups(geometry, geoData) {
    ...
    var remappedIndices = this.splitMaterialIndices(
      geoData.polygonDimensions,
