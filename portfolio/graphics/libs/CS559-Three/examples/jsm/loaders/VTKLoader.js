        ...
        if (ele.attributes.format === "binary" && compressed) {
          ...
          for (var i = 0; i < blocks; i++) {
            ...
            for (var j = 1; j < numBytes - 1; j++) {
              ...
              currentBlockSize =
                currentBlockSize |
                (byteData[i * numBytes + cSizeStart + j] << (j * 8));
            }
          ...
          for (var i = 0; i < dataOffsets.length - 1; i++) {
            var inflate = new Inflate(
              byteData.slice(dataOffsets[i], dataOffsets[i + 1]),
              { resize: true, verify: true }
      ...
      if (json.PolyData) {
        ...
        while (sectionIndex < numberOfSections) {
          ...
          if (section && section.DataArray) {
            ...
            if (
              Object.prototype.toString.call(section.DataArray) ===
              "[object Array]"
            ) {
            ...
            while (dataArrayIndex < numberOfDataArrays) {
              // Parse the DataArray
              if (
                "#text" in arr[dataArrayIndex] &&
                arr[dataArrayIndex]["#text"].length > 0
              ) {
                arr[dataArrayIndex].text = parseDataArray(
                  arr[dataArrayIndex],
                  compressed
                );
              }
            ...
            switch (sections[sectionIndex]) {
              ...
              case "Points":
                ...
                if (numberOfPoints > 0) {
                  var components =
                    section.DataArray.attributes.NumberOfComponents;
              ...
              case "Strips":
                ...
                if (numberOfStrips > 0) {
                  var connectivity = new Int32Array(
                    section.DataArray[0].text.length
                  );
