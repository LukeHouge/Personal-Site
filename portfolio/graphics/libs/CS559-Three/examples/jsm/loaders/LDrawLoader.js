...
var LDrawLoader = (function () {
  ...
  function LDrawLoader(manager) {
    ...
    this.setMaterials([
      this.parseColourMetaDirective(
        new LineParser("Main_Colour CODE 16 VALUE #FF8080 EDGE #333333")
      ),
      this.parseColourMetaDirective(
        new LineParser("Edge_Colour CODE 24 VALUE #A0A0A0 EDGE #333333")
      ),
    ]);
  ...
  LDrawLoader.prototype = Object.assign(Object.create(Loader.prototype), {
    ...
    newParseScopeLevel: function (materials) {
      ...
      var newParseScope = {
        ...
        mainEdgeColourCode: topParseScope
          ? topParseScope.mainEdgeColourCode
          : "24",
        ...
        switch (token.toUpperCase()) {
          ...
          case "EDGE":
            ...
            if (edgeColour.startsWith("0x")) {
              ...
              if (!edgeMaterial) {
                throw (
                  "LDrawLoader: Invalid edge colour while parsing material" +
                  lineParser.getLineNumberString() +
                  "."
                );
              }
          ...
          case "ALPHA":
            ...
            if (isNaN(alpha)) {
              throw (
                "LDrawLoader: Invalid alpha value in material definition" +
                lineParser.getLineNumberString() +
                "."
              );
            }
          ...
          case "LUMINANCE":
            ...
            if (isNaN(luminance)) {
              throw (
                "LDrawLoader: Invalid luminance value in material definition" +
                LineParser.getLineNumberString() +
                "."
              );
            }
      ...
      for (lineIndex = 0; lineIndex < numLines; lineIndex++) {
        ...
        if (parsingEmbeddedFiles) {
          if (line.startsWith("0 FILE ")) {
            ...
            this.subobjectCache[currentEmbeddedFileName.toLowerCase()] =
              currentEmbeddedText;
        ...
        switch (lineType) {
              ...
              switch (meta) {
                ...
                case "!COLOUR":
                  ...
                  if (material) {
                    ...
                    console.warn(
                      "LDrawLoader: Error parsing material" +
                ...
                case "BFC":
                  ...
                  while (!lp.isAtTheEnd()) {
                    ...
                    switch (token) {
                      ...
                      default:
                        console.warn(
                          'THREE.LDrawLoader: BFC directive "' +
                            token +
                            '" is unknown.'
                        );
          ...
          case "5":
            ...
            var segment = {
              material:
                material.userData.edgeMaterial.userData.conditionalEdgeMaterial,
              colourCode: material.userData.code,
              v0: parseVector(lp),
              v1: parseVector(lp),
              c0: parseVector(lp),
    ...
    processObject: function (text, onProcessed, subobject, url) {
      ...
      // Set current matrix
      if (subobject) {
        parseScope.currentMatrix.multiplyMatrices(
          parentParseScope.currentMatrix,
          subobject.matrix
        );
        parseScope.matrix.copy(subobject.matrix);
        parseScope.inverted = subobject.inverted;
        parseScope.startingConstructionStep =
          subobject.startingConstructionStep;
      }
      ...
      function finalizeObject() {
        ...
        var isRoot = !parentParseScope.isFromParse;
        if (
          (scope.separateObjects && !isPrimitiveType(parseScope.type)) ||
          isRoot
        ) {
      ...
      function loadSubobject(subobject) {
        ...
        parseScope.mainEdgeColourCode =
          subobject.material.userData.edgeMaterial.userData.code;
        parseScope.currentFileName = subobject.originalFileName;

        // If subobject was cached previously, use the cached one
        var cached =
          scope.subobjectCache[subobject.originalFileName.toLowerCase()];
        if (cached) {
          scope.processObject(
            cached,
        ...
        switch (subobject.locationState) {
          ...
          case LDrawLoader.FILE_LOCATION_TRY_RELATIVE:
            subobjectURL =
              url.substring(0, url.lastIndexOf("/") + 1) + subobjectURL;
            newLocationState = subobject.locationState + 1;
            break;
          ...
          case LDrawLoader.FILE_LOCATION_NOT_FOUND:
            ...
            console.warn(
              'LDrawLoader: Subobject "' +
                subobject.originalFileName +
                '" could not be found.'
            );
