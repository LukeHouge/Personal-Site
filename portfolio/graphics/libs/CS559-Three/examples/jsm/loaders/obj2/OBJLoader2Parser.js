...
OBJLoader2Parser.prototype = {
  ...
  setCallbackOnAssetAvailable: function (onAssetAvailable) {
    if (
      ...
      onAssetAvailable instanceof Function
    ) {
  ...
  _onAssetAvailable: function (/*payload*/) {
    const errorMessage =
      "OBJLoader2Parser does not provide implementation for onAssetAvailable. Aborting...";
  ...
  _configure: function () {
    ...
    if (this.logging.enabled) {
      ...
      printedConfig +=
        ...
        this.callbacks.onAssetAvailable.name;
  ...
  _buildFace: function (faceIndexV, faceIndexU, faceIndexN) {
    ...
    const updateSubGroupInUse = function () {
      ...
      let indexPointerV =
        ...
        (faceIndexVi > 0
          ? faceIndexVi - 1
          : faceIndexVi + scope.vertices.length / 3);
      ...
      if (faceIndexU) {
        ...
        let indexPointerU =
          ...
          (faceIndexUi > 0
            ? faceIndexUi - 1
            : faceIndexUi + scope.uvs.length / 2);
      ...
      if (faceIndexN && !scope.disregardNormals) {
        ...
        let indexPointerN =
          ...
          (faceIndexNi > 0
            ? faceIndexNi - 1
            : faceIndexNi + scope.normals.length / 3);
  ...
  _buildMesh: function (result) {
    ...
    for (const oodIndex in meshOutputGroups) {
      ...
      if (
        (materialOrg === undefined || materialOrg === null) &&
        (material === undefined || material === null)
      ) {
        materialName = haveVertexColors
