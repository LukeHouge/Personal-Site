  ...
  serializeClass: function (
    ...
    for (const name in targetPrototype.prototype) {
      ...
      if (name === "constructor") {
        ...
        if (
          funcTemp instanceof CodeSerializationInstruction &&
          funcTemp.getName() === funcInstructions.getName()
        ) {
      ...
      if (typeof objectPart === "function") {
        ...
        if (typeof objectPart === "string" || objectPart instanceof String) {
          ...
          console.log(
            'Omitting object "' +
              funcInstructions.getName() +
              '" and replace it with empty object.'
          );
