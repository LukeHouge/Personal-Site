      ...
      1: [
        function (require, module, exports) {
          ...
          function tinf_build_bits_base(e, t, n, r) {
            var s, i;
            for (s = 0; n > s; ++s) e[s] = 0;
            for (s = 0; 30 - n > s; ++s) e[s + n] = (s / n) | 0;
            for (i = r, s = 0; 30 > s; ++s) (t[s] = i), (i += 1 << e[s]);
          }
          ...
          function tinf_build_tree(e, t, n, r) {
            var s, i;
            for (s = 0; 16 > s; ++s) e.table[s] = 0;
            for (s = 0; r > s; ++s) e.table[t[n + s]]++;
            for (e.table[0] = 0, i = 0, s = 0; 16 > s; ++s)
              (offs[s] = i), (i += e.table[s]);
            for (s = 0; r > s; ++s) t[n + s] && (e.trans[offs[t[n + s]]++] = s);
          }
          ...
          function tinf_decode_trees(e, t, n) {
            var r, s, i, a, o, _;
            for (
              r = tinf_read_bits(e, 5, 257),
                s = tinf_read_bits(e, 5, 1),
                i = tinf_read_bits(e, 4, 4),
                a = 0;
              19 > a;
              ++a
            )
            ...
            for (
              tinf_build_tree(code_tree, lengths, 0, 19), o = 0;
              r + s > o;
              ...
              switch (d) {
                case 16:
                  var b = lengths[o - 1];
                  for (_ = tinf_read_bits(e, 2, 3); _; --_) lengths[o++] = b;
                  break;
                case 17:
                  for (_ = tinf_read_bits(e, 3, 3); _; --_) lengths[o++] = 0;
                  break;
                case 18:
                  for (_ = tinf_read_bits(e, 7, 11); _; --_) lengths[o++] = 0;
                  break;
                default:
                  lengths[o++] = d;
              }
            }
            tinf_build_tree(t, lengths, 0, r),
              tinf_build_tree(n, lengths, r, s);
          }
          function tinf_inflate_block_data(e, t, n) {
            for (;;) {
              ...
              if (256 > r) e.dest[e.destLen++] = r;
                ...
                for (
                  r -= 257,
                    s = tinf_read_bits(e, length_bits[r], length_base[r]),
                    i = tinf_decode_symbol(e, n),
                    a =
                      e.destLen - tinf_read_bits(e, dist_bits[i], dist_base[i]),
                    o = a;
                  a + s > o;
                  ++o
                )
          ...
          function tinf_inflate_uncompressed_block(e) {
            ...
            if (
              ...
              (n = e.source[e.sourceIndex + 3]),
              (n = 256 * n + e.source[e.sourceIndex + 2]),
              t !== (65535 & ~n))
            )
            ...
            do {
              switch (((n = tinf_getbit(i)), (r = tinf_read_bits(i, 2, 0)))) {
                ...
                case 1:
                  ...
                  break;
                case 2:
                  tinf_decode_trees(i, i.ltree, i.dtree),
                    (s = tinf_inflate_block_data(i, i.ltree, i.dtree));
                  break;
                default:
                  s = TINF_DATA_ERROR;
              }
        ...
        function (require, module, exports) {
          ...
          function GlyphNames(e) {
            ...
            switch (e.version) {
              ...
              case 2:
                for (
                  this.names = new Array(e.numberOfGlyphs), l = 0;
                  l < e.numberOfGlyphs;
                  l++
                )
                  this.names[l] =
                    e.glyphNameIndex[l] < exports.standardNames.length
                      ? exports.standardNames[e.glyphNameIndex[l]]
                      : e.names[
                          e.glyphNameIndex[l] - exports.standardNames.length
                        ];
                break;
              case 2.5:
                for (
                  ...
                  this.names[l] =
                    exports.standardNames[l + e.glyphNameIndex[l]];
                break;
              case 3:
                this.names = [];
            }
          ...
          function addGlyphNames(e) {
            for (
              var l, r = e.tables.cmap.glyphIndexMap, a = Object.keys(r), s = 0;
              s < a.length;
              s += 1
            ) {
              var i = a[s],
            ...
            for (s = 0; s < e.glyphs.length; s += 1)
              (l = e.glyphs.get(s)),
                e.cffEncoding
                  ? (l.name = e.cffEncoding.charset[s])
                  : e.glyphNames.names &&
                    (l.name = e.glyphNames.glyphIndexToName(s));
          }
        ...
        function (require, module, exports) {
          ...
          function Font(e) {
            (e = e || {}),
              ...
              (this.supported = !0),
              (this.glyphs = new glyphset.GlyphSet(this, e.glyphs || [])),
          ...
          (Font.prototype.hasChar = function (e) {
            ...
            (Font.prototype.forEachGlyph = function (e, t, n, i, r, o) {
              (t = void 0 !== t ? t : 0),
                ...
                (r = r || {});
              for (
                var s = void 0 === r.kerning ? !0 : r.kerning,
                ...
                if (
                  (o(c, t, n, i, r),
                  c.advanceWidth && (t += c.advanceWidth * a),
                  s && u < h.length - 1)
                ) {
              ...
              if (util.isBrowser())
                (window.requestFileSystem =
                  ...
                  window.requestFileSystem(
                    ...
                    i.byteLength,
                    function (e) {
                      e.root.getFile(n, { create: !0 }, function (e) {
        ...
        function (require, module, exports) {
          ...
          (Glyph.prototype.bindConstructorValues = function (t) {
            (this.index = t.index || 0),
              ...
              (this.unicodes =
                t.unicodes || void 0 !== t.unicode ? [t.unicode] : []),
            ...
            (Glyph.prototype.getPath = function (t, i, e, n) {
              (t = void 0 !== t ? t : 0),
                (i = void 0 !== i ? i : 0),
                (n = void 0 !== n ? n : { xScale: 1, yScale: 1 }),
                (e = void 0 !== e ? e : 72);
              for (
                var a = (1 / this.path.unitsPerEm) * e,
                  h = n.xScale * a,
                  o = n.yScale * a,
                  r = new path.Path(),
                ...
                var y = s[p];
                "M" === y.type
                  ? r.moveTo(t + y.x * h, i + -y.y * o)
                  : "L" === y.type
                  ? r.lineTo(t + y.x * h, i + -y.y * o)
                  : "Q" === y.type
                  ? r.quadraticCurveTo(
                      t + y.x1 * h,
                      i + -y.y1 * o,
            ...
            (Glyph.prototype.getMetrics = function () {
              for (
                var t = this.path.commands, i = [], e = [], n = 0;
                n < t.length;
                n += 1
              ) {
                var a = t[n];
                "Z" !== a.type && (i.push(a.x), e.push(a.y)),
                  ("Q" === a.type || "C" === a.type) &&
                    (i.push(a.x1), e.push(a.y1)),
                  "C" === a.type && (i.push(a.x2), e.push(a.y2));
              }
              var h = {
              ...
              return (
                isFinite(h.xMin) || (h.xMin = 0),
                isFinite(h.xMax) || (h.xMax = this.advanceWidth),
                isFinite(h.yMin) || (h.yMin = 0),
                isFinite(h.yMax) || (h.yMax = 0),
                (h.rightSideBearing =
                  this.advanceWidth - h.leftSideBearing - (h.xMax - h.xMin)),
                h
              );
            }),
            ...
            (Glyph.prototype.drawPoints = function (t, i, e, n) {
              function a(i, e, n, a) {
                ...
                for (var o = 0; o < i.length; o += 1)
                  t.moveTo(e + i[o].x * a, n + i[o].y * a),
                    t.arc(e + i[o].x * a, n + i[o].y * a, 2, 0, h, !1);
                t.closePath(), t.fill();
              }
              (i = void 0 !== i ? i : 0),
                (e = void 0 !== e ? e : 0),
                (n = void 0 !== n ? n : 24);
              for (
                var h = (1 / this.path.unitsPerEm) * n,
                  o = [],
                  r = [],
                  s = this.path,
                  p = 0;
                ...
                var y = s.commands[p];
                void 0 !== y.x && o.push({ x: y.x, y: -y.y }),
                  void 0 !== y.x1 && r.push({ x: y.x1, y: -y.y1 }),
                  void 0 !== y.x2 && r.push({ x: y.x2, y: -y.y2 });
              }
              (t.fillStyle = "blue"),
                a(o, i, e, h),
                (t.fillStyle = "red"),
            ...
            (Glyph.prototype.drawMetrics = function (t, i, e, n) {
              ...
              (i = void 0 !== i ? i : 0),
                ...
                (t.lineWidth = 1),
                (t.strokeStyle = "black"),
                draw.line(t, i, -1e4, i, 1e4),
                draw.line(t, -1e4, e, 1e4, e);
              var h = this.xMin || 0,
                o = this.yMin || 0,
                r = this.xMax || 0,
                s = this.yMax || 0,
              ...
              (t.strokeStyle = "blue"),
                draw.line(t, i + h * a, -1e4, i + h * a, 1e4),
                draw.line(t, i + r * a, -1e4, i + r * a, 1e4),
                draw.line(t, -1e4, e + -o * a, 1e4, e + -o * a),
                draw.line(t, -1e4, e + -s * a, 1e4, e + -s * a),
                (t.strokeStyle = "green"),
                draw.line(t, i + p * a, -1e4, i + p * a, 1e4);
            }),
            (exports.Glyph = Glyph);
        },
        { "./check": 2, "./draw": 3, "./path": 11 },
      ],
      7: [
        function (require, module, exports) {
          "use strict";
          ...
          function glyphLoader(e, t) {
            return new _glyph.Glyph({ index: t, font: e });
          }
          function ttfGlyphLoader(e, t, n, r, p, h) {
            return function () {
              var i = new _glyph.Glyph({ index: t, font: e });
              return (
                (i.path = function () {
                  n(i, r, p);
                  var t = h(e.glyphs, i);
                ...
                defineDependentProperty(i, "xMin", "_xMin"),
                defineDependentProperty(i, "xMax", "_xMax"),
                defineDependentProperty(i, "yMin", "_yMin"),
                defineDependentProperty(i, "yMax", "_yMax"),
                i
              );
            };
          }
          function cffGlyphLoader(e, t, n, r) {
            return function () {
              var p = new _glyph.Glyph({ index: t, font: e });
              return (
                (p.path = function () {
                  var t = n(e, p, r);
                  return (t.unitsPerEm = e.unitsPerEm), t;
        ...
        function (require, module, exports) {
          ...
          var check = require("./check"),
            Layout = {
              ...
              getFeatureTable: function (e, r, t, a) {
                ...
                if (s) {
                  for (
                    var n,
                      u = s.featureIndexes,
                      i = this.font.tables.gsub.features,
                      g = 0;
                    g < u.length;
                    g++
                  )
              ...
              getLookupTable: function (e, r, t, a, s) {
                var n = this.getFeatureTable(e, r, t, s);
                if (n) {
                  for (
                    var u,
                      i = n.lookupListIndexes,
        ...
        function (require, module, exports) {
          ...
          function loadFromFile(e, a) {
            ...
            r.readFile(e, function (e, r) {
              return e
                ? a(e.message)
                : void a(null, util.nodeBufferToArrayBuffer(r));
            });
          }
          function loadFromUrl(e, a) {
            ...
            r.open("get", e, !0),
              ...
              (r.onload = function () {
                return 200 !== r.status
                  ? a("Font could not be loaded: " + r.statusText)
                  : a(null, r.response);
              }),
              r.send();
          }
          ...
          function uncompressTable(e, a) {
            if ("WOFF" === a.compression) {
              var r = new Uint8Array(
                  e.buffer,
                  a.offset + 2,
                  a.compressedLength - 2
                ),
                s = new Uint8Array(a.originalLength);
              if ((inflate(r, s), s.byteLength !== a.originalLength))
                throw new Error(
                  "Decompression error: " +
                    a.tag +
              ...
              return { data: t, offset: 0 };
            }
            return { data: e, offset: a.offset };
          }
          function parseBuffer(e) {
            var a,
              r,
              s,
              t = new _font.Font({ empty: !0 }),
              n = new DataView(e, 0),
              o = [],
              p = parse.getTag(n, 0);
            if (p === String.fromCharCode(0, 1, 0, 0))
              (t.outlinesFormat = "truetype"),
                (s = parse.getUShort(n, 4)),
                (o = parseOpenTypeTableEntries(n, s));
            else if ("OTTO" === p)
              ...
              if ("wOFF" !== p)
                throw new Error("Unsupported OpenType signature " + p);
              var l = parse.getTag(n, 4);
              if (l === String.fromCharCode(0, 1, 0, 0))
                t.outlinesFormat = "truetype";
              else {
                if ("OTTO" !== l)
                  throw new Error("Unsupported OpenType flavor " + p);
                t.outlinesFormat = "cff";
              }
            ...
            for (var f, u, i, c, b, m, d, g, h, T, y = 0; s > y; y += 1) {
              ...
              switch (F.tag) {
                case "cmap":
                  (v = uncompressTable(n, F)),
                    (t.tables.cmap = cmap.parse(v.data, v.offset)),
                    (t.encoding = new encoding.CmapEncoding(t.tables.cmap));
                  break;
                case "fvar":
                  u = F;
                  break;
                case "head":
                  (v = uncompressTable(n, F)),
                    (t.tables.head = head.parse(v.data, v.offset)),
                    (t.unitsPerEm = t.tables.head.unitsPerEm),
                    (a = t.tables.head.indexToLocFormat);
                  break;
                case "hhea":
                  (v = uncompressTable(n, F)),
                    (t.tables.hhea = hhea.parse(v.data, v.offset)),
                    (t.ascender = t.tables.hhea.ascender),
                    (t.descender = t.tables.hhea.descender),
                    (t.numberOfHMetrics = t.tables.hhea.numberOfHMetrics);
                  break;
                case "hmtx":
                  m = F;
                  break;
                case "ltag":
                  (v = uncompressTable(n, F)),
                    (r = ltag.parse(v.data, v.offset));
                  break;
                case "maxp":
                  (v = uncompressTable(n, F)),
                    (t.tables.maxp = maxp.parse(v.data, v.offset)),
                ...
                case "OS/2":
                  (v = uncompressTable(n, F)),
                    (t.tables.os2 = os2.parse(v.data, v.offset));
                  break;
                case "post":
                  (v = uncompressTable(n, F)),
                    (t.tables.post = post.parse(v.data, v.offset)),
                    (t.glyphNames = new encoding.GlyphNames(t.tables.post));
                  break;
                case "glyf":
                  i = F;
                  break;
            ...
            if (
              ((t.tables.name = _name.parse(q.data, q.offset, r)),
              (t.names = t.tables.name),
              i && g)
            ) {
              var k = 0 === a,
            ...
            if (T) {
              ...
              (t.tables.meta = meta.parse(C.data, C.offset)),
                (t.metas = t.tables.meta);
            }
            return t;
          }
          function load(e, a) {
        ...
        function (require, module, exports) {
          ...
          (exports.getByte = function (t, r) {
            ...
            (exports.getBytes = function (t, r, e) {
              for (var s = [], a = r; e > a; a += 1) s.push(t.getUint8(a));
              return s;
            }),
          ...
          (Parser.prototype.parseByte = function () {
            ...
            (Parser.prototype.skip = function (t, r) {
              void 0 === r && (r = 1),
                (this.relativeOffset += typeOffsets[t] * r);
            }),
            ...
            (Parser.prototype.parseList = function (t, r) {
              ...
              for (var e = new Array(t), s = 0; t > s; s++) e[s] = r.call(this);
              return e;
            }),
            (Parser.prototype.parseRecordList = function (t, r) {
              r || ((r = t), (t = this.parseUShort()));
              for (
                var e = new Array(t), s = Object.keys(r), a = 0;
                t > a;
                a++
              ) {
            ...
            (Parser.prototype.parsePointer = function (t) {
              ...
              return r > 0
                ? new Parser(this.data, this.offset + r).parseStruct(t)
                : void 0;
            }),
            (Parser.prototype.parseListOfLists = function (t) {
              for (
                var r = this.parseOffset16List(),
                  e = r.length,
            ...
            (Parser.prototype.parseCoverage = function () {
              var t = this.offset + this.relativeOffset,
                ...
                e = this.parseUShort();
              if (1 === r)
                return { format: 1, glyphs: this.parseUShortList(e) };
              if (2 === r) {
              ...
              check.assert(
                !1,
                "0x" + t.toString(16) + ": Coverage format must be 1 or 2."
              );
            }),
            (Parser.prototype.parseClassDef = function () {
              ...
              return 1 === r
                ...
                : void check.assert(
                    !1,
                    "0x" + t.toString(16) + ": ClassDef format must be 1 or 2."
                  );
            }),
      ...
      11: [
        function (require, module, exports) {
          ...
          (Path.prototype.moveTo = function (t, o) {
            this.commands.push({ type: "M", x: t, y: o });
          }),
            (Path.prototype.lineTo = function (t, o) {
              this.commands.push({ type: "L", x: t, y: o });
            }),
            (Path.prototype.curveTo = Path.prototype.bezierCurveTo =
              function (t, o, e, i, s, h) {
                this.commands.push({
                  type: "C",
                  x1: t,
                  y1: o,
            ...
            (Path.prototype.quadTo = Path.prototype.quadraticCurveTo =
              function (t, o, e, i) {
                this.commands.push({ type: "Q", x1: t, y1: o, x: e, y: i });
              }),
            (Path.prototype.close = Path.prototype.closePath =
              function () {
            ...
            (Path.prototype.toPathData = function (t) {
              ...
              for (var i = "", s = 0; s < this.commands.length; s += 1) {
                ...
                "M" === h.type
                  ...
                  ? (i += "L" + e(h.x, h.y))
                  : "C" === h.type
                  ? (i += "C" + e(h.x1, h.y1, h.x2, h.y2, h.x, h.y))
                  : "Q" === h.type
                  ? (i += "Q" + e(h.x1, h.y1, h.x, h.y))
                  : "Z" === h.type && (i += "Z");
              }
              return i;
            }),
      ...
      12: [
        function (require, module, exports) {
          ...
          function arraysEqual(t, e) {
            ...
            for (var a = 0; r > a; a++) if (t[a] !== e[a]) return !1;
            return !0;
          }
          ...
          var check = require("./check"),
            ...
            Substitution = function (t) {
              this.font = t;
            };
          (Substitution.prototype = Layout),
            (Substitution.prototype.getGsubTable = function (t) {
              var e = this.font.tables.gsub;
              return (
                !e &&
                  t &&
                  (this.font.tables.gsub = e =
                    {
                      version: 1,
                      scripts: [
                        {
            ...
            (Substitution.prototype.getAlternates = function (t, e, r) {
              ...
              for (var o = s.subtables, u = 0; u < o.length; u++)
                for (
                  var i = o[u],
                    n = this.expandCoverage(i.coverage),
                    g = i.alternateSets,
                    l = 0;
                  l < n.length;
                  l++
                )
                  a.push({ sub: n[l], by: g[l] });
              return a;
            }),
              ...
              for (var o = s.subtables, u = 0; u < o.length; u++)
                for (
                  ...
                  for (var c = n[l], b = g[l], h = 0; h < b.length; h++) {
                    var p = b[h];
                    a.push({ sub: [c].concat(p.components), by: p.ligGlyph });
                  }
              return a;
            }),
            (Substitution.prototype.addSingle = function (t, e, r, a) {
              ...
              0 > i &&
                ((i = -1 - i),
                o.coverage.glyphs.splice(i, 0, u),
                o.substitute.splice(i, 0, 0)),
                (o.substitute[i] = e.by);
            }),
            (Substitution.prototype.addAlternate = function (t, e, r, a) {
              ...
              0 > i &&
                ((i = -1 - i),
                o.coverage.glyphs.splice(i, 0, u),
                o.alternateSets.splice(i, 0, 0)),
                (o.alternateSets[i] = e.by);
            }),
            (Substitution.prototype.addLigature = function (t, e, r, a) {
              ...
              if (g >= 0) {
                ...
                (g = -1 - g),
                  o.coverage.glyphs.splice(g, 0, u),
                  o.ligatureSets.splice(g, 0, [n]);
            }),
            (Substitution.prototype.getFeature = function (t, e, r) {
              if (((e = e || "DFLT"), (r = r || "DFLT"), /ss\d\d/.test(t)))
                return this.getSingle(t, e, r);
              switch (t) {
                case "aalt":
                case "salt":
                  return this.getSingle(t, e, r).concat(
                    this.getAlternates(t, e, r)
                  );
                case "dlig":
                case "liga":
                case "rlig":
            ...
            (Substitution.prototype.add = function (t, e, r, a) {
              if (((r = r || "DFLT"), (a = a || "DFLT"), /ss\d\d/.test(t)))
                return this.addSingle(t, e, r, a);
              switch (t) {
                case "aalt":
                case "salt":
                  return "number" == typeof e.by
                    ? this.addSingle(t, e, r, a)
                    : this.addAlternate(t, e, r, a);
                case "dlig":
                case "liga":
                case "rlig":
      ...
      13: [
        function (require, module, exports) {
          ...
          function ushortList(e, t, a) {
            ...
            r[0] = { name: e + "Count", type: "USHORT", value: a };
            for (var o = 0; o < t.length; o++)
              r[o + 1] = { name: e + o, type: "USHORT", value: t[o] };
            return r;
          }
          function tableList(e, t, a) {
            var r = t.length,
              o = new Array(r + 1);
            o[0] = { name: e + "Count", type: "USHORT", value: r };
            for (var s = 0; r > s; s++)
              o[s + 1] = { name: e + s, type: "TABLE", value: a(t[s], s) };
            return o;
          }
          function recordList(e, t, a) {
            var r = t.length,
              o = [];
            o[0] = { name: e + "Count", type: "USHORT", value: r };
            for (var s = 0; r > s; s++) o = o.concat(a(t[s], s));
            return o;
          }
          function Coverage(e) {
            1 === e.format
              ? Table.call(
                  ...
                  [{ name: "coverageFormat", type: "USHORT", value: 1 }].concat(
                    ushortList("glyph", e.glyphs)
                  )
                )
              : check.assert(!1, "Can't create coverage table format 2 yet.");
          }
          function ScriptList(e) {
            Table.call(
              this,
              "scriptListTable",
              recordList("scriptRecord", e, function (e, t) {
                var a = e.script,
                  r = a.defaultLangSys;
                return (
                  check.assert(
                        ...
                        [
                          {
                            ...
                            value: new Table(
                              ...
                              [
                                ...
                                ushortList("featureIndex", r.featureIndexes)
                              )
                            ),
                          },
                        ].concat(
          ...
          function FeatureList(e) {
            Table.call(
              this,
              "featureListTable",
              recordList("featureRecord", e, function (e, t) {
                var a = e.feature;
                return [
                  { name: "featureTag" + t, type: "TAG", value: e.tag },
                  {
                    ...
                    value: new Table(
                      ...
                      [
                        ...
                        ushortList("lookupListIndex", a.lookupListIndexes)
                      )
                    ),
                  },
                ];
      ...
      14: [
        function (require, module, exports) {
          ...
          function parseCFFIndex(e, t, a) {
            ...
            return { objects: o, startOffset: t, endOffset: s };
          }
          ...
          function parseOperand(e, t) {
            var a, r, n, s;
            if (28 === t)
              return (a = e.parseByte()), (r = e.parseByte()), (a << 8) | r;
            if (29 === t)
              return (
                (a = e.parseByte()),
                (r = e.parseByte()),
            ...
            if (t >= 247 && 250 >= t)
              return (a = e.parseByte()), 256 * (t - 247) + a + 108;
            if (t >= 251 && 254 >= t)
              return (a = e.parseByte()), 256 * -(t - 251) - a - 108;
          ...
          function entriesToObject(e) {
            for (var t = {}, a = 0; a < e.length; a += 1) {
              var r,
                n = e[a][0],
                s = e[a][1];
              if (((r = 1 === s.length ? s[0] : s), t.hasOwnProperty(n)))
          ...
          function parseCFFDict(e, t, a) {
            ...
            for (a = void 0 !== a ? a : e.length; r.relativeOffset < a; ) {
              var i = r.parseByte();
              21 >= i
                ? (12 === i && (i = 1200 + r.parseByte()),
                  n.push([i, s]),
                  (s = []))
                : s.push(parseOperand(r, i));
            }
          ...
          function interpretDict(e, t, a) {
            for (var r = {}, n = 0; n < t.length; n += 1) {
              var s = t[n],
                i = e[s.op];
              void 0 === i && (i = void 0 !== s.value ? s.value : null),
                "SID" === s.type && (i = getCFFString(a, i)),
                (r[s.name] = i);
            }
            return r;
          }
          function parseCFFHeader(e, t) {
            var a = {};
            return (
              (a.formatMajor = parse.getCard8(e, t)),
              (a.formatMinor = parse.getCard8(e, t + 1)),
              (a.size = parse.getCard8(e, t + 2)),
              (a.offsetSize = parse.getCard8(e, t + 3)),
              (a.startOffset = t),
              (a.endOffset = t + 4),
              a
            );
          ...
          function parseCFFCharset(e, t, a, r) {
            ...
            if (0 === f)
              ...
              for (; h.length <= a; )
                for (
                  s = o.parseSID(), i = o.parseCard8(), n = 0;
                  i >= n;
                  n += 1
                )
              ...
              for (; h.length <= a; )
                for (
                  s = o.parseSID(), i = o.parseCard16(), n = 0;
                  i >= n;
                  n += 1
                )
                  h.push(getCFFString(r, s)), (s += 1);
          ...
          function parseCFFEncoding(e, t, a) {
            ...
            if (0 === o) {
              var h = i.parseCard8();
              for (r = 0; h > r; r += 1) (n = i.parseCard8()), (s[n] = r);
            } else {
              if (1 !== o) throw new Error("Unknown encoding format " + o);
              var f = i.parseCard8();
              for (n = 1, r = 0; f > r; r += 1)
                for (
                  var p = i.parseCard8(), u = i.parseCard8(), l = p;
                  p + u >= l;
                  l += 1
                )
                  (s[l] = n), (n += 1);
          ...
          function parseCFFCharstring(e, t, a) {
            ...
            function s(a) {
              for (
                var y, b, C, T, F, I, D, x, k, S, E, O, R = 0;
                R < a.length;
                ...
                switch (((R += 1), M)) {
                  ...
                  case 6:
                    for (
                      ;
                      u.length > 0 &&
                      ((v += u.shift()), p.lineTo(v, m), 0 !== u.length);
                  ...
                  case 7:
                    for (
                      ;
                      u.length > 0 &&
                      ((m += u.shift()), p.lineTo(v, m), 0 !== u.length);
                    ...
                    switch (((M = a[R]), (R += 1), M)) {
                      case 35:
                        (i = v + u.shift()),
                          ...
                          (m = O + u.shift()),
                          u.shift(),
                          p.curveTo(i, o, h, f, D, x),
                          p.curveTo(k, S, E, O, v, m);
                        break;
                      case 34:
                        (i = v + u.shift()),
                          (o = m),
                  ...
                  default:
                    32 > M
                      ...
                      ? ((y = a[R]),
                        (R += 1),
                        u.push(256 * (M - 247) + y + 108))
                      : 255 > M
                      ? ((y = a[R]),
                        (R += 1),
                        u.push(256 * -(M - 251) - y - 108))
                      : ((y = a[R]),
                        (b = a[R + 1]),
                        (C = a[R + 2]),
                        (T = a[R + 3]),
                        (R += 4),
                        u.push(((y << 24) | (b << 16) | (C << 8) | T) / 65536));
                }
              }
            }
            var i,
          ...
          function calcCFFSubroutineBias(e) {
            var t;
            return (t =
              e.length < 1240 ? 107 : e.length < 33900 ? 1131 : 32768);
          }
          function parseCFFTable(e, t, a) {
            ...
            (a.gsubrs = o.objects),
              (a.gsubrsBias = calcCFFSubroutineBias(a.gsubrs));
            ...
            if (
              ((a.defaultWidthX = u.defaultWidthX),
              (a.nominalWidthX = u.nominalWidthX),
              0 !== u.subrs)
            ) {
              var l = p + u.subrs,
                c = parseCFFIndex(e, l);
              (a.subrs = c.objects),
                (a.subrsBias = calcCFFSubroutineBias(a.subrs));
            ...
            (a.cffEncoding =
              0 === f.encoding
                ? new encoding.CffEncoding(encoding.cffStandardEncoding, g)
                : 1 === f.encoding
                ? new encoding.CffEncoding(encoding.cffExpertEncoding, g)
                : parseCFFEncoding(e, t + f.encoding, g)),
              (a.encoding = a.encoding || a.cffEncoding),
              (a.glyphs = new glyphset.GlyphSet(a));
            for (var v = 0; v < a.nGlyphs; v += 1) {
              var m = d.objects[v];
              a.glyphs.push(
                v,
                glyphset.cffGlyphLoader(a, v, parseCFFCharstring, m)
              );
            }
          }
          function encodeString(e, t) {
            ...
            return (
              ...
              (r = t.indexOf(e)),
              r >= 0
                ? (a = r + encoding.cffStandardStrings.length)
                : ((a = encoding.cffStandardStrings.length + t.length),
                  t.push(e)),
              a
            );
          }
          ...
          function makeNameIndex(e) {
            ...
            t.names = [];
            for (var a = 0; a < e.length; a += 1)
              t.names.push({ name: "name_" + a, type: "NAME", value: e[a] });
            return t;
          }
          function makeDict(e, t, a) {
            for (var r = {}, n = 0; n < e.length; n += 1) {
              ...
              void 0 === i ||
                equals(i, s.value) ||
                ("SID" === s.type && (i = encodeString(i, a)),
                (r[s.op] = { name: s.name, type: s.type, value: i }));
            }
            return r;
          }
          ...
          function makeCharsets(e, t) {
            for (
              var a = new table.Record("Charsets", [
              ...
              var n = e[r],
                s = encodeString(n, t);
              a.fields.push({ name: "glyph_" + r, type: "SID", value: s });
            }
            return a;
          }
          function glyphToOps(e) {
            ...
            for (var r = 0, n = 0, s = 0; s < a.commands.length; s += 1) {
              ...
              if ("M" === h.type)
                (i = Math.round(h.x - r)),
                  (o = Math.round(h.y - n)),
                  t.push({ name: "dx", type: "NUMBER", value: i }),
                ...
                (i = Math.round(h.x - h.x2)),
                  (o = Math.round(h.y - h.y2)),
                  t.push({ name: "dx1", type: "NUMBER", value: u }),
                  t.push({ name: "dy1", type: "NUMBER", value: l }),
          ...
          function makeCFFTable(e, t) {
            ...
            var f = [];
            (r.header = makeHeader()),
              (r.nameIndex = makeNameIndex([t.postScriptName]));
            var p = makeTopDict(s, f);
            (r.topDictIndex = makeTopDictIndex(p)),
              (r.globalSubrIndex = makeGlobalSubrIndex()),
              (r.charsets = makeCharsets(o, f)),
              (r.charStringsIndex = makeCharStringsIndex(e)),
              (r.privateDict = makePrivateDict(i, f)),
              (r.stringIndex = makeStringIndex(f));
            var u =
              r.header.sizeOf() +
              r.nameIndex.sizeOf() +
      ...
      15: [
        function (require, module, exports) {
          ...
          function parseCmapTableFormat12(e, a) {
            var r;
            a.parseUShort(),
              (e.length = a.parseULong()),
              (e.language = a.parseULong());
            var t;
            for (
              e.groupCount = t = a.parseULong(), e.glyphIndexMap = {}, r = 0;
              t > r;
              r += 1
            )
              for (
          ...
          function parseCmapTableFormat4(e, a, r, t, n) {
            ...
            for (s = 0; o - 1 > s; s += 1)
              for (
                ...
                0 !== i
                  ? ((u = m.offset + m.relativeOffset - 2),
                    (u += i),
                    (u += 2 * (v - c)),
                    (h = parse.getUShort(r, u)),
                    0 !== h && (h = (h + d) & 65535))
                  : (h = (v + d) & 65535),
                  (e.glyphIndexMap[v] = h);
          }
          function parseCmapTable(e, a) {
            var r,
              t = {};
            (t.version = parse.getUShort(e, a)),
              check.argument(
                0 === t.version,
                "cmap table version should be 0."
              ),
              (t.numTables = parse.getUShort(e, a + 2));
            var n = -1;
            ...
            if (((t.format = l.parseUShort()), 12 === t.format))
              parseCmapTableFormat12(t, l);
            else {
              if (4 !== t.format)
                throw new Error(
                  "Only format 4 and 12 cmap tables are supported."
                );
          ...
          function addSegment(e, a, r) {
            e.segments.push({ end: a, start: a, delta: -(a - r), offset: 0 });
          }
          ...
          function makeCmapTable(e) {
            ...
            (s = r.segments.length),
              (r.segCountX2 = 2 * s),
              (r.searchRange =
                2 * Math.pow(2, Math.floor(Math.log(s) / Math.log(2)))),
      ...
      16: [
        function (require, module, exports) {
          ...
          function makeFvarAxis(e, a, r) {
            ...
            return [
              { name: "tag_" + e, type: "TAG", value: a.tag },
              { name: "minValue_" + e, type: "FIXED", value: a.minValue << 16 },
              {
                name: "defaultValue_" + e,
                type: "FIXED",
                value: a.defaultValue << 16,
              },
              { name: "maxValue_" + e, type: "FIXED", value: a.maxValue << 16 },
          ...
          function parseFvarAxis(e, a, r) {
            ...
            return (
              (n.tag = t.parseTag()),
              (n.minValue = t.parseFixed()),
              (n.defaultValue = t.parseFixed()),
              (n.maxValue = t.parseFixed()),
              t.skip("uShort", 1),
              (n.name = r[t.parseUShort()] || {}),
              n
            );
          }
          function makeFvarInstance(e, a, r, n) {
            for (
              var t = addName(a.name, n),
                s = [
                  { name: "nameID_" + e, type: "USHORT", value: t },
                  { name: "flags_" + e, type: "USHORT", value: 0 },
                ],
                u = 0;
              u < r.length;
          ...
          function makeFvarTable(e, a) {
            ...
            for (var t = 0; t < e.instances.length; t++)
              r.fields = r.fields.concat(
                makeFvarInstance(t, e.instances[t], e.axes, a)
              );
            return r;
          }
      ...
      17: [
        function (require, module, exports) {
          ...
          function parseGlyphCoordinate(e, r, t, o, a) {
            ...
            return (
              (r & o) > 0
                ? ((n = e.parseByte()), 0 === (r & a) && (n = -n), (n = t + n))
                : (n = (r & a) > 0 ? t : t + e.parseShort()),
              n
            );
          }
            ...
            if (e.numberOfContours > 0) {
              ...
              for (
                e.instructionLength = o.parseUShort(),
                  e.instructions = [],
                  s = 0;
                s < e.instructionLength;
                s += 1
              )
                e.instructions.push(o.parseByte());
              var i = p[p.length - 1] + 1;
              for (a = [], s = 0; i > s; s += 1)
                if (((n = o.parseByte()), a.push(n), (8 & n) > 0))
                  for (var h = o.parseByte(), l = 0; h > l; l += 1)
                    a.push(n), (s += 1);
              if (
                (check.argument(a.length === i, "Bad flags."), p.length > 0)
              ) {
                var u,
                  c = [];
                if (i > 0) {
                  for (s = 0; i > s; s += 1)
                    (n = a[s]),
                      (u = {}),
                      (u.onCurve = !!(1 & n)),
                      (u.lastPointOfContour = p.indexOf(s) >= 0),
                      c.push(u);
                  var y = 0;
                  for (s = 0; i > s; s += 1)
                    (n = a[s]),
                      (u = c[s]),
                      (u.x = parseGlyphCoordinate(o, n, y, 2, 16)),
                      (y = u.x);
                  var f = 0;
                  for (s = 0; i > s; s += 1)
                    (n = a[s]),
                      (u = c[s]),
                      (u.y = parseGlyphCoordinate(o, n, f, 4, 32)),
                      (f = u.y);
                }
                e.points = c;
              } else e.points = [];
          ...
          function getPath(e) {
            ...
            for (var t = getContours(e), o = 0; o < t.length; o += 1) {
              ...
              for (var h = n ? 1 : 0; h < s.length; h += 1) {
                var l = s[h],
                  u = 0 === h ? p : s[h - 1];
                if (u.onCurve && l.onCurve) r.lineTo(l.x, l.y);
                else if (u.onCurve && !l.onCurve) a = l;
                else if (u.onCurve || l.onCurve) {
                  if (u.onCurve || !l.onCurve)
                    throw new Error("Invalid state.");
                  r.quadraticCurveTo(a.x, a.y, l.x, l.y), (a = null);
                } else {
                  var c = { x: (u.x + l.x) / 2, y: (u.y + l.y) / 2 };
                  r.quadraticCurveTo(u.x, u.y, c.x, c.y), (a = l);
                }
              }
              p !== i &&
                (a
                  ? r.quadraticCurveTo(a.x, a.y, p.x, p.y)
                  : r.lineTo(p.x, p.y));
            }
            ...
            if (r.isComposite)
              for (var t = 0; t < r.components.length; t += 1) {
                ...
                if ((a.getPath(), a.points)) {
                  var n;
                  if (void 0 === o.matchedPoints)
                    n = transformPoints(a.points, o);
                  else {
                    if (
                      o.matchedPoints[0] > r.points.length - 1 ||
                      o.matchedPoints[1] > a.points.length - 1
                    )
                    ...
                    (p = transformPoints([p], i)[0]),
                      (i.dx = s.x - p.x),
                      (i.dy = s.y - p.y),
                      (n = transformPoints(a.points, i));
                  }
          ...
          function parseGlyfTable(e, r, t, o) {
            ...
            for (a = 0; a < t.length - 1; a += 1) {
              ...
              s !== p
                ...
                : n.push(a, glyphset.glyphLoader(o, a));
            }
            return n;
          }
          var check = require("../check"),
        ...
        { "../check": 2, "../glyphset": 7, "../parse": 10, "../path": 11 },
      ],
      18: [
        function (require, module, exports) {
          "use strict";
          function parseTaggedListTable(r, e) {
            for (
              ...
              t[a.parseTag()] = { offset: a.parseUShort() };
            return t;
          }
              ...
              if (2 === o) {
                for (
                  var b = t.parseUShort(),
                    ...
                    L = t.parseUShort(),
                    k = t.parseUShort(),
                    d = parseClassDefTable(r, e + b),
                    w = parseClassDefTable(r, e + P),
                    O = [],
                    C = 0;
                  L > C;
                  C++
          ...
          function parseGposTable(r, e, a) {
            ...
            check.argument(1 === t, "Unsupported GPOS table version."),
              parseTaggedListTable(r, e + s.parseUShort()),
              parseTaggedListTable(r, e + s.parseUShort());
            var o = s.parseUShort();
            s.relativeOffset = o;
            for (
              var p = s.parseUShort(),
                n = s.parseOffset16List(p),
                f = e + o,
                i = 0;
              p > i;
              i++
              ...
              2 !== h.lookupType ||
                a.getGposKerningValue ||
                (a.getGposKerningValue = h.getKerningValue);
            }
          }
          var check = require("../check"),
            parse = require("../parse");
        ...
        function (require, module, exports) {
          ...
          function parseGsubTable(e, t) {
            ...
            var s = new Parser(e, t),
              r = s.parseVersion();
            return (
              check.argument(1 === r, "Unsupported GSUB table version."),
              {
                version: r,
              ...
              return (
                ...
                new table.Table(
                  ...
                  [
                    ...
                    table.tableList("altSet", e.alternateSets, function (e) {
                      return new table.Table(
                        "alternateSetTable",
                        table.ushortList("alternate", e)
                      );
                    })
                  )
                )
              ...
              return (
                ...
                new table.Table(
                  ...
                  [
                    ...
                    table.tableList("ligSet", e.ligatureSets, function (e) {
                      return new table.Table(
                        "ligatureSetTable",
                        table.tableList("ligature", e, function (e) {
                          return new table.Table(
                            "ligatureTable",
                            [
                              {
      ...
      20: [
        function (require, module, exports) {
          ...
          function parseHeadTable(e, a) {
            ...
            return (
              (t.version = r.parseVersion()),
              (t.fontRevision = Math.round(1e3 * r.parseFixed()) / 1e3),
              (t.checkSumAdjustment = r.parseULong()),
              (t.magicNumber = r.parseULong()),
              check.argument(
                1594834165 === t.magicNumber,
                "Font header has wrong magic number."
              ),
              (t.flags = r.parseUShort()),
              (t.unitsPerEm = r.parseUShort()),
              (t.created = r.parseLongDateTime()),
              (t.modified = r.parseLongDateTime()),
              (t.xMin = r.parseShort()),
              (t.yMin = r.parseShort()),
              (t.xMax = r.parseShort()),
              (t.yMax = r.parseShort()),
              (t.macStyle = r.parseUShort()),
              (t.lowestRecPPEM = r.parseUShort()),
              (t.fontDirectionHint = r.parseShort()),
              (t.indexToLocFormat = r.parseShort()),
              (t.glyphDataFormat = r.parseShort()),
              t
            );
          }
          function makeHeadTable(e) {
            var a = Math.round(new Date().getTime() / 1e3) + 2082844800,
              t = a;
            return (
              e.createdTimestamp && (t = e.createdTimestamp + 2082844800),
              new table.Table(
                "head",
                [
                  ...
                  { name: "modified", type: "LONGDATETIME", value: a },
      ...
      22: [
        function (require, module, exports) {
          ...
          function makeHmtxTable(e) {
            for (
              var a = new table.Table("hmtx", []), r = 0;
              r < e.length;
              r += 1
            ) {
              var t = e.get(r),
        ...
        function (require, module, exports) {
          ...
          function parseKernTable(r, e) {
            var a = {},
              ...
              p = s.parseUShort();
            check.argument(0 === p, "Unsupported kern table version."),
              s.skip("uShort", 1);
            var t = s.parseUShort();
            check.argument(0 === t, "Unsupported kern sub-table version."),
              s.skip("uShort", 2);
            var o = s.parseUShort();
            s.skip("uShort", 3);
            for (var n = 0; o > n; n += 1) {
      ...
      24: [
        function (require, module, exports) {
          ...
          function parseLocaTable(r, a, e, s) {
            for (
              var p = new parse.Parser(r, a),
                o = s ? p.parseUShort : p.parseULong,
                t = [],
                c = 0;
              e + 1 > c;
              c += 1
        ...
        function (require, module, exports) {
          ...
          function parseLtagTable(e, a) {
            var r = new parse.Parser(e, a),
              t = r.parseULong();
            check.argument(1 === t, "Unsupported ltag table version."),
              r.skip("uLong", 1);
            for (var n = r.parseULong(), s = [], l = 0; n > l; l++) {
              for (
                var p = "", u = a + r.parseUShort(), g = r.parseUShort(), o = u;
                u + g > o;
                ++o
              )
        ...
        function (require, module, exports) {
          ...
          function parseMaxpTable(e, a) {
            var r = {},
              s = new parse.Parser(e, a);
            return (
              (r.version = s.parseVersion()),
              (r.numGlyphs = s.parseUShort()),
              1 === r.version &&
                ((r.maxPoints = s.parseUShort()),
                (r.maxContours = s.parseUShort()),
                (r.maxCompositePoints = s.parseUShort()),
                (r.maxCompositeContours = s.parseUShort()),
                (r.maxZones = s.parseUShort()),
                (r.maxTwilightPoints = s.parseUShort()),
                (r.maxStorage = s.parseUShort()),
                (r.maxFunctionDefs = s.parseUShort()),
                (r.maxInstructionDefs = s.parseUShort()),
                (r.maxStackElements = s.parseUShort()),
                (r.maxSizeOfInstructions = s.parseUShort()),
                (r.maxComponentElements = s.parseUShort()),
                (r.maxComponentDepth = s.parseUShort())),
              r
            );
          }
      ...
      27: [
        function (require, module, exports) {
          ...
          function parseMetaTable(e, a) {
            var r = new parse.Parser(e, a),
              t = r.parseULong();
            check.argument(1 === t, "Unsupported META table version."),
              r.parseULong(),
              r.parseULong();
          ...
          function makeMetaTable(e) {
            var a = Object.keys(e).length,
              ...
              s = new table.Table("meta", [
                { name: "version", type: "ULONG", value: 1 },
                { name: "flags", type: "ULONG", value: 0 },
                { name: "offset", type: "ULONG", value: t },
                { name: "numTags", type: "ULONG", value: a },
              ]);
            for (var n in e) {
              var p = r.length;
              (r += e[n]),
                s.fields.push({ name: "tag " + n, type: "TAG", value: n }),
                s.fields.push({
                  name: "offset " + n,
                  type: "ULONG",
                  value: t + p,
        ...
        { "../check": 2, "../parse": 10, "../table": 13, "../types": 32 },
      ],
      28: [
        function (require, module, exports) {
          "use strict";
            ...
            for (
              ...
              if (void 0 !== v && void 0 !== h) {
                ...
                if (
                  (x =
                    v === utf16
                      ? decode.UTF16(e, i + p, f)
                      : decode.MACSTRING(e, i + p, f, v))
                ) {
                  var y = n[d];
          ...
          function findSubArray(e, a) {
            ...
            e: for (var t = 0; n > t; t++)
              for (; n > t; t++) {
                for (var s = 0; r > s; s++) if (a[t + s] !== e[s]) continue e;
                return t;
              }
            return -1;
          }
          function addStringToPool(e, a) {
            ...
            if (0 > r) {
              r = a.length;
              for (var n = 0, t = e.length; t > n; ++n) a.push(e[n]);
            }
            return r;
          }
          function makeNameTable(e, a) {
            ...
            for (var m in e) {
              var i = s[m];
              if ((void 0 === i && (i = m), (r = parseInt(i)), isNaN(r)))
                throw new Error(
                  'Name table entry "' +
                    m +
            ...
            for (
              var c = reverseDict(macLanguages),
                o = reverseDict(windowsLanguages),
                u = [],
                l = [],
                g = 0;
              g < n.length;
            ...
            u.sort(function (e, a) {
              return (
                e.platformID - a.platformID ||
                e.encodingID - a.encodingID ||
                e.languageID - a.languageID ||
                e.nameID - a.nameID
              );
            });
            for (
              var U = new table.Table("name", [
            ...
            return (
              U.fields.push({ name: "strings", type: "LITERAL", value: l }), U
            );
          }
          var types = require("../types"),
            decode = types.decode,
      ...
      29: [
        function (require, module, exports) {
          ...
          function parseOS2Table(e, n) {
            ...
            (a.version = i.parseUShort()),
              (a.xAvgCharWidth = i.parseShort()),
              (a.usWeightClass = i.parseUShort()),
              (a.usWidthClass = i.parseUShort()),
              (a.fsType = i.parseUShort()),
              (a.ySubscriptXSize = i.parseShort()),
              (a.ySubscriptYSize = i.parseShort()),
              (a.ySubscriptXOffset = i.parseShort()),
              (a.ySubscriptYOffset = i.parseShort()),
              (a.ySuperscriptXSize = i.parseShort()),
              (a.ySuperscriptYSize = i.parseShort()),
              (a.ySuperscriptXOffset = i.parseShort()),
              (a.ySuperscriptYOffset = i.parseShort()),
              (a.yStrikeoutSize = i.parseShort()),
              (a.yStrikeoutPosition = i.parseShort()),
              (a.sFamilyClass = i.parseShort()),
              (a.panose = []);
            for (var t = 0; 10 > t; t++) a.panose[t] = i.parseByte();
            return (
              (a.ulUnicodeRange1 = i.parseULong()),
              (a.ulUnicodeRange2 = i.parseULong()),
              (a.ulUnicodeRange3 = i.parseULong()),
              (a.ulUnicodeRange4 = i.parseULong()),
              (a.achVendID = String.fromCharCode(
                i.parseByte(),
                i.parseByte(),
                i.parseByte(),
                i.parseByte()
              )),
              (a.fsSelection = i.parseUShort()),
              (a.usFirstCharIndex = i.parseUShort()),
              (a.usLastCharIndex = i.parseUShort()),
              (a.sTypoAscender = i.parseShort()),
              (a.sTypoDescender = i.parseShort()),
              (a.sTypoLineGap = i.parseShort()),
              (a.usWinAscent = i.parseUShort()),
              (a.usWinDescent = i.parseUShort()),
              a.version >= 1 &&
                ((a.ulCodePageRange1 = i.parseULong()),
                (a.ulCodePageRange2 = i.parseULong())),
              a.version >= 2 &&
                ((a.sxHeight = i.parseShort()),
                (a.sCapHeight = i.parseShort()),
                (a.usDefaultChar = i.parseUShort()),
                (a.usBreakChar = i.parseUShort()),
                (a.usMaxContent = i.parseUShort())),
              a
            );
          }
        ...
        function (require, module, exports) {
          ...
          function makeTableRecord(e, a, n, t) {
            return new table.Record("Table Record", [
              ...
              { name: "checkSum", type: "ULONG", value: void 0 !== a ? a : 0 },
              { name: "offset", type: "ULONG", value: void 0 !== n ? n : 0 },
              { name: "length", type: "ULONG", value: void 0 !== t ? t : 0 },
            ]);
          }
          function makeSfntTable(e) {
            ...
            (a.searchRange = 16 * n),
              (a.entrySelector = log2(n)),
              (a.rangeShift = 16 * a.numTables - a.searchRange);
            for (
              var t = [],
                r = [],
                i = a.sizeOf() + makeTableRecord().sizeOf() * a.numTables;
              i % 4 !== 0;

            )
              (i += 1), r.push({ name: "padding", type: "BYTE", value: 0 });
            for (var s = 0; s < e.length; s += 1) {
              var l = e[s];
              check.argument(
                4 === l.tableName.length,
                "Table name" + l.tableName + " is invalid."
              );
              var u = l.sizeOf(),
                m = makeTableRecord(
                  l.tableName,
                  computeCheckSum(l.encode()),
                  i,
                  u
                );
              for (
            ...
            return (
              ...
              (a.fields = a.fields.concat(t)),
              (a.fields = a.fields.concat(r)),
              a
            );
          }
          ...
          function average(e) {
            for (var a = 0, n = 0; n < e.length; n += 1) a += e[n];
            return a / e.length;
          }
          function fontToSfntTable(e) {
            for (
              ...
              if (32 > v) h |= 1 << v;
              else if (64 > v) o |= 1 << (v - 32);
              else if (96 > v) c |= 1 << (v - 64);
              else {
                if (!(123 > v))
                  throw new Error(
            ...
            var b = head.make({
              ...
              T = os2.make({
                ...
                sCapHeight: metricsForChar(e, "HIKLEFJMNTZBDPRAGOQSUVWXY", x)
                  .yMax,
            ...
            O || (O = C.replace(/\s/g, "") + "-" + N);
            var W = {};
            for (var q in e.names) W[q] = e.names[q];
            W.uniqueID ||
              (W.uniqueID = { en: e.getEnglishName("manufacturer") + ":" + E }),
              W.postScriptName || (W.postScriptName = { en: O }),
            ...
            var w = [],
              ...
              G = [b, M, S, T, B, R, L, A, k];
            U && G.push(U),
              e.tables.gsub && G.push(gsub.make(e.tables.gsub)),
              F && G.push(F);
      ...
      32: [
        function (require, module, exports) {
          ...
          (encode.BYTE = function (e) {
            ...
            (encode.CHAR = function (e) {
              return [e.charCodeAt(0)];
            }),
            (sizeOf.CHAR = constant(1)),
            (encode.CHARARRAY = function (e) {
            ...
            (encode.SHORT = function (e) {
              return (
                e >= LIMIT16 && (e = -(2 * LIMIT16 - e)),
                [(e >> 8) & 255, 255 & e]
              );
            }),
            (sizeOf.SHORT = constant(2)),
            (encode.UINT24 = function (e) {
              return [(e >> 16) & 255, (e >> 8) & 255, 255 & e];
            }),
            (sizeOf.UINT24 = constant(3)),
            (encode.ULONG = function (e) {
              return [
                (e >> 24) & 255,
                (e >> 16) & 255,
                (e >> 8) & 255,
            ...
            (encode.LONG = function (e) {
              return (
                e >= LIMIT32 && (e = -(2 * LIMIT32 - e)),
            ...
            (encode.LONGDATETIME = function (e) {
              return [
                0,
                0,
                0,
            ...
            (encode.NUMBER = function (e) {
              return e >= -107 && 107 >= e
                ? [e + 139]
                : e >= 108 && 1131 >= e
                ? ((e -= 108), [(e >> 8) + 247, 255 & e])
                : e >= -1131 && -108 >= e
                ? ((e = -e - 108), [(e >> 8) + 251, 255 & e])
                : e >= -32768 && 32767 >= e
                ? encode.NUMBER16(e)
                : encode.NUMBER32(e);
            }),
          ...
          var macEncodingTableCache =
            ...
            getMacEncodingTable = function (e) {
              ...
              return (
                macEncodingTableCache && macEncodingTableCache.set(t, r), r
              );
            };
          (encode.MACSTRING = function (e, n) {
            ...
            (encode.DICT = function (e) {
              for (
                var n = [], t = Object.keys(e), o = t.length, c = 0;
                o > c;
                c += 1
              ) {
                var r = parseInt(t[c], 0),
                  i = e[r];
                (n = n.concat(encode.OPERAND(i.value, i.type))),
                  (n = n.concat(encode.OPERATOR(r)));
              }
              return n;
            }),
              ...
              if (Array.isArray(n))
                for (var o = 0; o < n.length; o += 1)
                  check.argument(
                    ...
                    (t = t.concat(encode.OPERAND(e[o], n[o])));
              else if ("SID" === n) t = t.concat(encode.NUMBER(e));
              else if ("offset" === n) t = t.concat(encode.NUMBER32(e));
              else if ("number" === n) t = t.concat(encode.NUMBER(e));
              else {
          ...
          (encode.CHARSTRING = function (e) {
            ...
            (encode.TABLE = function (e) {
              ...
              for (n = 0; o > n; n += 1) {
                ...
                var d = a(f);
                "TABLE" === i.type
                  ? (r.push(t.length), (t = t.concat([0, 0])), c.push(d))
                  : (t = t.concat(d));
              }
              for (n = 0; n < c.length; n += 1) {
                var u = r[n],
                  s = t.length;
                check.argument(65536 > s, "Table " + e.tableName + " too big."),
                  (t[u] = s >> 8),
                  (t[u + 1] = 255 & s),
                  (t = t.concat(c[n]));
              }
        ...
        function (require, module, exports) {
          ...
          (exports.isBrowser = function () {
            ...
            (exports.nodeBufferToArrayBuffer = function (r) {
              for (
                var e = new ArrayBuffer(r.length), n = new Uint8Array(e), t = 0;
                t < r.length;
                ++t
              )
                n[t] = r[t];
            ...
            (exports.arrayBufferToNodeBuffer = function (r) {
              for (
                var e = new Buffer(r.byteLength), n = new Uint8Array(r), t = 0;
                t < e.length;
                ++t
              )
                e[t] = n[t];
...
export var opentype = window.opentype;
