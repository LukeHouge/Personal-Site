...
!(function (t, e) {
  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      function l(t, e) {
        if (Array.isArray(t))
          for (var n = 0; n < t.length; n++) e.call(null, t[n], n);
        else {
      ...
      function B(t) {
        ...
        for (var r = 0; r < e.length; r++) {
          var o = e[r];
          if (!f(o))
            for (var a = i(o), s = 0; s < a.length; s++) {
              var u = a[s];
              g(t, u) || (t[u] = o[u]);
            }
        }
    ...
    function (t, e, n) {
      ...
      function T(t) {
        ...
        if (t instanceof p)
          return { type: "Flat", definition: e(t.definition) };
        if (t instanceof l)
        ...
        if (t instanceof y) {
          ...
          return (
            t.terminalType.PATTERN &&
              (n.pattern = o.isRegExp(r) ? r.source : r),
            n
          );
        }
        if (t instanceof c)
    ...
    function (t, e, n) {
      ...
      function u(t) {
        return r.isObject(t) &&
          t.hasOwnProperty("tokenName") &&
          r.isString(t.tokenName)
          ? t.tokenName
          : i.functionName(t);
      }
    ...
    function (t, e, n) {
      ...
      var o = n(4),
        ...
        v = n(37),
        g = n(38);
      (e.END_OF_FILE = u.createTokenInstance(
        u.EOF,
        "",
        NaN,
        NaN,
      ...
      var _ = (function () {
        function t(t, n) {
          ...
          this.initErrorHandler(n),
            ...
            (this.ignoredIssues = a.has(n, "ignoredIssues")
              ? n.ignoredIssues
              : e.DEFAULT_PARSER_CONFIG.ignoredIssues),
        ...
        return (
          ...
          (t.prototype.performSelfAnalysis = function () {
            ...
            var f = h.resolveGrammar({ rules: i.values() });
            if (
              (this.definitionErrors.push.apply(this.definitionErrors, f),
              a.isEmpty(f))
            ) {
            ...
            if (
              ...
              throw (
                ((e = a.map(this.definitionErrors, function (t) {
                  return t.message;
                })),
                new Error(
        ...
        i = (function () {
          ...
          return (
            (t.prototype.visit = function (t) {
              ...
              if (t instanceof r.RepetitionMandatory)
                return this.visitRepetitionMandatory(t);
              if (t instanceof r.RepetitionMandatoryWithSeparator)
                return this.visitRepetitionMandatoryWithSeparator(t);
              if (t instanceof r.RepetitionWithSeparator)
            ...
            (t.prototype.visitRepetitionMandatoryWithSeparator = function (
              t
            ) {}),
    ...
    function (t, e, n) {
      ...
      function s(t) {
        r.forEach(t, function (t) {
          l(t) ||
            (e.tokenIdxToClass.put(e.tokenShortNameIdx, t),
            (t.tokenTypeIdx = e.tokenShortNameIdx++)),
      ...
      (e.tokenStructuredMatcher = function (t, e) {
        ...
        return (
          n === e.tokenTypeIdx ||
          (!0 === e.isParent && !0 === e.categoryMatchesMap[n])
        );
      }),
      ...
      (e.isSequenceProd = function (t) {
        ...
        (e.isOptionalProd = function t(e, n) {
          return (
            void 0 === n && (n = []),
            !!(
              e instanceof a.Option ||
              e instanceof a.Repetition ||
              e instanceof a.RepetitionWithSeparator
            ) ||
        ...
        (e.getProductionDslName = function (t) {
          ...
          if (t instanceof a.RepetitionMandatoryWithSeparator)
      ...
      var c = (function (t) {
        ...
        return (
          ...
          (e.prototype.visitTerminal = function (t) {
            ...
            o.has(this.dslMethods, e) || (this.dslMethods[e] = []),
              this.dslMethods[e].push(t);
          }),
        ...
        (e.defaultGrammarValidatorErrorProvider = {
          ...
          buildInvalidNestedRuleNameError: function (t, e) {
            return (
              ...
              u.validNestedRuleName.toString() +
          ...
          buildAlternationAmbiguityError: function (t) {
            ...
            return (i =
              ...
              p.DEFAULT_PARSER_CONFIG.maxLookahead +
          ...
          buildDuplicateRuleNameError: function (t) {
            return (
              ...
              (t.topLevelRule instanceof a.Rule
                ? t.topLevelRule.name
                : t.topLevelRule) +
    ...
    function (t, e, n) {
            ...
            return (
              a.forEach(t, function (t) {
                ...
                if (a.contains(i, e)) {
                  ...
                  r.push({
                    message: o,
                    type: s.ParserDefinitionErrorType
                      .CONFLICT_TOKENS_RULES_NAMESPACE,
                    ruleName: e,
                  });
                }
      ...
      function _(t, e, n, r) {
        ...
        if (
          ...
          var o = r.buildDuplicateRuleNameError({
            topLevelRule: t,
            grammarName: n,
          });
          i.push({
      ...
      function R(t, e, n, r) {
        ...
        var c = o.difference(a, r.concat([t])),
      ...
      function A(t) {
        ...
        else if (!(n instanceof f.Terminal))
          throw Error("non exhaustive match");
        var r = u.isOptionalProd(n),
          i = t.length > 1;
        if (r && i) {
          var a = o.drop(t);
          return e.concat(A(a));
      ...
      (e.OccurrenceValidationCollector = y),
        ...
        (e.validNestedRuleName = new RegExp(
          e.validTermsPattern.source.replace("^", "^\\$")
        )),
      ...
      function S(t, e, n, r) {
        var i = new N();
        t.accept(i);
        var c = i.alternations,
          l = n[t.name];
        return (
          l &&
            (c = a.reject(c, function (t) {
      ...
      (e.validateEmptyOrAlternative = O),
        (e.validateAmbiguousAlternationAlternatives = S);
      var I = (function (t) {
        function e() {
          var e = (null !== t && t.apply(this, arguments)) || this;
          return (e.allProductions = []), e;
          ...
          a.forEach(t, function (t) {
            ...
            a.forEach(o, function (i) {
              ...
              if (a.isEmpty(a.flatten(c))) {
                var l = n.buildEmptyRepetitionError({
                  topLevelRule: t,
                  repetition: i,
                });
                r.push({
    ...
    function (t, e, n) {
      ...
      !(function (t) {
        ...
        (e.getProdType = function (t) {
          ...
          if (t instanceof p.RepetitionMandatoryWithSeparator)
            return o.REPETITION_MANDATORY_WITH_SEPARATOR;
          if (t instanceof p.RepetitionWithSeparator)
        ...
        (e.buildLookaheadFuncForOr = function (t, e, n, r, i, o) {
          ...
          return o(
            ...
            r,
            T(a)
              ? c.tokenStructuredMatcherNoCategories
              : c.tokenStructuredMatcher,
            i
          );
        }),
      ...
      var h = (function (t) {
          ...
          return (
            ...
            (e.prototype.walkOption = function (e, n, r) {
              this.checkIsTarget(e, o.OPTION, n, r) ||
                t.prototype.walkOption.call(this, e, n, r);
            }),
            (e.prototype.walkAtLeastOne = function (e, n, r) {
              this.checkIsTarget(e, o.REPETITION_MANDATORY, n, r) ||
                t.prototype.walkOption.call(this, e, n, r);
            }),
            (e.prototype.walkAtLeastOneSep = function (e, n, r) {
              this.checkIsTarget(
                e,
                o.REPETITION_MANDATORY_WITH_SEPARATOR,
                n,
                r
              ) || t.prototype.walkOption.call(this, e, n, r);
            }),
            (e.prototype.walkMany = function (e, n, r) {
              this.checkIsTarget(e, o.REPETITION, n, r) ||
                t.prototype.walkOption.call(this, e, n, r);
            }),
            (e.prototype.walkManySep = function (e, n, r) {
              this.checkIsTarget(e, o.REPETITION_WITH_SEPARATOR, n, r) ||
                t.prototype.walkOption.call(this, e, n, r);
            }),
            e
          );
              ...
              return a.every(e, function (e, n) {
                return (
                  ...
                  r === i ||
                    (r &&
                      i &&
                      (r.categoryMatchesMap[i.tokenTypeIdx] ||
                        i.categoryMatchesMap[r.tokenTypeIdx]))
                );
                var r, i;
              });
            })
          ...
          for (var h = 0; h < l.length; h++)
            for (var f = l[h], d = n(l, h), E = 0; E < f.length; E++) {
              ...
              if (r(d, m) || a.isEmpty(T) || m.length === e) {
                ...
                var g = s.possiblePathsFrom(T, p + 1, m);
                c[h] = c[h].concat(g);
              }
            }
        }
      ...
      function m(t, e, n, r) {
        ...
        return d(
          [new p.Flat({ definition: o }), new p.Flat({ definition: a })],
          r
        );
      }
      function y(t, e) {
    ...
    function (t, e, n) {
        ...
        p = (function (t) {
          ...
          return (
            ...
            (e.prototype.walk = function (e, n) {
              void 0 === n && (n = []),
                this.found || t.prototype.walk.call(this, e, n);
            }),
      ...
      function y(t, e, n, r) {
        ...
        return (
          o.push(1),
          { idx: e, def: t.definition, ruleStack: i, occurrenceStack: o }
        );
      }
      (e.NextTerminalAfterAtLeastOneSepWalker = m),
        (e.possiblePathsFrom = function t(e, n, r) {
          ...
          var i = [],
            o = 0;
          function s(s) {
            var u = t(s.concat(a.drop(e, o + 1)), n, r);
            return i.concat(u);
          }
          for (; r.length < n && o < e.length; ) {
            ...
            if (u instanceof c.Option) i = s(u.definition);
              ...
              if (u instanceof c.RepetitionMandatory)
                return s(
                  (p = u.definition.concat([
                    new c.Repetition({ definition: u.definition }),
                  ]))
                );
              if (u instanceof c.RepetitionMandatoryWithSeparator)
                return s(
                  (p = [
                    ...
                    new c.Repetition({
                      definition: [
                        new c.Terminal({ terminalType: u.separator }),
                      ].concat(u.definition),
                    }),
                  ])
                );
              if (u instanceof c.RepetitionWithSeparator) {
                ...
                if (u instanceof c.Alternation)
                  return (
                    a.forEach(u.definition, function (t) {
                      i = s(t.definition);
                    }),
                    i
                  );
                if (!(u instanceof c.Terminal))
                  throw Error("non exhaustive match");
            ...
            if ("EXIT_ALTERNATIVE" !== h) {
              ...
              if (!a.isEmpty(f)) {
                ...
                if ("EXIT_NONE_TERMINAL" === T) {
                  ...
                  for (var L = T.definition.length - 1; L >= 0; L--) {
                    var k = {
                      idx: d,
    ...
    function (t, e, n) {
            ...
            (t.prototype.walk = function (t, e) {
              ...
              void 0 === e && (e = []),
                r.forEach(t.definition, function (o, a) {
                  ...
                  else if (o instanceof i.RepetitionMandatory)
                    n.walkAtLeastOne(o, s, e);
                  else if (o instanceof i.RepetitionMandatoryWithSeparator)
                    n.walkAtLeastOneSep(o, s, e);
                  else if (o instanceof i.RepetitionWithSeparator)
                    n.walkManySep(o, s, e);
                  else if (o instanceof i.Repetition) n.walkMany(o, s, e);
                  else {
                    if (!(o instanceof i.Alternation))
                      throw Error("non exhaustive match");
                    n.walkOr(o, s, e);
                  }
                });
      ...
      function a(t, e, n) {
        return [
          new i.Option({
            definition: [new i.Terminal({ terminalType: t.separator })].concat(
              t.definition
            ),
          }),
        ].concat(e, n);
    ...
    function (t, e, n) {
      ...
      var u = (function () {
        function t(t, e) {
          ...
          if (
            ((this.config = i.merge(s, e)),
            this.config.lineTerminatorsPattern === s.lineTerminatorsPattern)
          )
            this.config.lineTerminatorsPattern =
              r.LineTerminatorOptimizedTester;
          else if (
            this.config.lineTerminatorCharacters === s.lineTerminatorCharacters
          )
            throw Error(
          ...
          var a,
            u = !0;
          i.isArray(t)
            ? (((a = { modes: {} }).modes[r.DEFAULT_MODE] = i.cloneArr(t)),
              (a[r.DEFAULT_MODE] = r.DEFAULT_MODE))
            : ((u = !1), (a = i.cloneObj(t))),
            (this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(
              r.performRuntimeChecks(
                a,
          ...
          if (
            (i.forEach(a.modes, function (t, a) {
              if (
                ...
                (n.patternIdxToConfig[a] = s.patternIdxToConfig),
                  (n.charCodeToPatternIdxToConfig[a] =
                    s.charCodeToPatternIdxToConfig),
            ...
            !i.isEmpty(this.lexerDefinitionErrors) &&
        ...
        return (
          ...
          (t.prototype.tokenizeInternal = function (t, e) {
            ...
            var F,
              ...
              D = function (t) {
                if (1 === C.length && void 0 === t.tokenType.PUSH_MODE) {
                  var e =
                    m.config.errorMessageProvider.buildUnableToPopLexerModeMessage(
                      t
                    );
                  A.push({
                  ...
                  C.pop();
                  var n = i.last(C);
                  (P = m.patternIdxToConfig[n]),
                    (x = m.charCodeToPatternIdxToConfig[n]),
                    (k = P.length);
              ...
              if (null !== u) {
                if (
                  ...
                  0 !== V &&
                    ((N += V),
                    (O = c - H),
                    this.updateTokenEndLineColumnLocation(h, p, H, V, N, O, c));
                }
                this.handleModes(F, D, w, h);
              } else {
                for (var X = v, z = N, q = O, $ = !1; !$ && v < T; )
                  for (
                    y.charCodeAt(v), t = this.chopInput(t, 1), v++, o = 0;
                    o < k;
                    o++
                  ) {
                    var Z,
            ...
            return (
              this.hasCustom || (R.length = g),
              { tokens: R, groups: S, errors: A }
            );
          }),
          ...
          (t.prototype.updateTokenEndLineColumnLocation = function (
            ...
            void 0 !== e &&
              ((u = (s = n === a - 1) ? -1 : 0),
              (1 === r && !0 === s) ||
                ((t.endLine = i + u), (t.endColumn = o - 1 - u)));
          }),
      ...
      var p = (function (t) {
        ...
        return (
          ...
          (e.prototype.collectNamedDSLMethod = function (t, e, n) {
            if (!o.isUndefined(t.name)) {
              ...
              if (
                ...
                if (
                  !(
                    t instanceof u.RepetitionMandatoryWithSeparator ||
                    t instanceof u.RepetitionWithSeparator
                  )
                )
                  throw Error("non exhaustive match");
                r = new e({
          ...
          (e.prototype.visitRepetitionMandatoryWithSeparator = function (t) {
            this.collectNamedDSLMethod(
              t,
              u.RepetitionMandatoryWithSeparator,
              s.AT_LEAST_ONE_SEP_IDX
            );
          }),
          (e.prototype.visitRepetitionWithSeparator = function (t) {
            this.collectNamedDSLMethod(
              t,
              u.RepetitionWithSeparator,
              s.MANY_SEP_IDX
            );
          }),
          (e.prototype.visitAlternation = function (t) {
            ...
            o.forEach(t.definition, function (r, i) {
              if (!o.isUndefined(r.name)) {
                var a = r.definition;
                a = n
                  ? [new u.Option({ definition: r.definition })]
                  : r.definition;
                var c = s.getKeyForAltIndex(e.ruleIdx, s.OR_IDX, t.idx, i);
    ...
    function (t, e, n) {
      ...
      (E.ParserDefinitionErrorType = r.ParserDefinitionErrorType),
        ...
        (E.RepetitionMandatoryWithSeparator =
          l.RepetitionMandatoryWithSeparator),
        (E.Option = l.Option),
        ...
        (E.defaultGrammarResolverErrorProvider =
          u.defaultGrammarResolverErrorProvider),
            ...
            typeof (r = function () {
              ...
              (t.prototype.saveState = function () {
                ...
                (t.prototype.nulCharacterAtom = function () {
                  return (
                    this.consumeChar("0"), { type: "Character", value: o("\0") }
                  );
                }),
    ...
    function (t, e, n) {
      ...
      function s(t) {
        for (
          var e, n = [], i = t.definition, s = 0, u = i.length > s, c = !0;
          u && c;

        )
          (e = i[s]),
            (c = o.isOptionalProd(e)),
            (n = n.concat(a(e))),
            (s += 1),
            (u = i.length > s);
        return r.uniq(n);
      ...
      (e.first = a),
        (e.firstForSequence = s),
        (e.firstForBranching = u),
        (e.firstForTerminal = c);
    },
    function (t, e, n) {
      "use strict";
    ...
    function (t, e, n) {
      ...
      var s = /(?:\s*{\s*NAME\s*:\s*["'`]([\w$]*)["'`])?/,
        ...
        g = new RegExp(
          /\.\s*MANY_SEP(\d+)?\s*\(\s*{/.source + u.source + v.source
        ),
        _ = new RegExp(g.source, "g"),
        R = new RegExp(
          /\.\s*AT_LEAST_ONE_SEP(\d+)?\s*\(\s*{/.source + u.source + v.source
        ),
        ...
        switch (t.type) {
          case r.AT_LEAST_ONE:
            return (function (t, e, n) {
              return M(
                O,
                new a.RepetitionMandatory({ definition: [] }),
                t,
                e,
                n
              );
      ...
      function F(t, n, r, i, a) {
        ...
        if (!p)
          throw Error("Separator Terminal Token name: " + c + " not found");
        var l = new r({ definition: [], separator: p, idx: u }),
          h = s[2];
      ...
      (e.terminalNameToConstructor = {}),
        (e.buildTopProduction = function (t, n, r) {
          ...
          return (function (t, e, n, r) {
            return b(
              new a.Rule({ name: t, definition: [], orgText: r }),
              e,
              n,
              t
            );
      ...
      function et(t) {
        ...
        return (
          ...
          o.uniq(e, function (t) {
            return (
              t.type + "~" + t.range.start + "~" + t.range.end + "~" + t.text
            );
          })
        );
      }
    ...
    function (t, e, n) {
      ...
      (e.resolveGrammar = function (t) {
        ...
        (e.assignOccurrenceIndices = function (t) {
          r.forEach(t.rules, function (t) {
            var e = new u.DslMethodsCollectorVisitor();
            t.accept(e),
    ...
    function (t, e, n) {
        ...
        return (
          ...
          (t.prototype.tryInRepetitionRecovery = function (t, e, n, r) {
            for (
              ...
              this.tokenMatcher(h, s)
                ? (p = !0)
                : ((h = this.SKIP_TOKEN()), this.addToResyncTokens(h, c));
            }
          ...
          (t.prototype.shouldInRepetitionRecoveryBeTried = function (t, e) {
            return (
              ...
              !this.canPerformInRuleRecovery(
                t,
                this.getFollowsForInRuleRecovery(t, e)
              )
            );
          }),
          ...
          (t.prototype.tryInRuleRecovery = function (t, e) {
            if (this.canRecoverWithSingleTokenInsertion(t, e))
          ...
          (t.prototype.canPerformInRuleRecovery = function (t, e) {
            return (
              this.canRecoverWithSingleTokenInsertion(t, e) ||
          ...
          (t.prototype.buildFullFollowKeyStack = function () {
            ...
            return (
              i.isEmpty(this.LAST_EXPLICIT_RULE_STACK) ||
                ((n = i.map(this.LAST_EXPLICIT_RULE_STACK, function (e) {
          ...
          (t.prototype.getHumanReadableRuleStack = function () {
            ...
            return i.isEmpty(this.LAST_EXPLICIT_RULE_STACK)
              ? i.map(this.RULE_STACK, function (e) {
      ...
      function l(t, e, n, i, o, a) {
        var s = this.getKeyForAutomaticLookahead(i, o),
          u = this.firstAfterRepMap.get(s);
        if (void 0 === u) {
          var c = this.getCurrRuleFullName();
          (u = new a(this.getGAstProductions().get(c), o).startWalking()),
            this.firstAfterRepMap.put(s, u);
        }
        var p = u.token,
          l = u.occurrence,
          h = u.isEndOfRule;
        1 === this.RULE_STACK.length &&
          ...
          void 0 === p &&
          ((p = r.EOF), (l = 1)),
          this.shouldInRepetitionRecoveryBeTried(p, l) &&
            this.tryInRepetitionRecovery(t, e, n, p);
      }
    ...
    function (t, e, n) {
              ...
              (k = u.reduce(
                ...
                function (t, e, r) {
                  if ("string" == typeof e.PATTERN) {
                    ...
                    u.forEach(e.START_CHARS_HINT, function (e) {
                    ...
                    if (e.PATTERN.unicode)
                      ...
                      var o = c.getStartCodes(e.PATTERN, n.ensureOptimizations);
                      u.isEmpty(o) && (A = !1),
        ...
        (e.validatePatterns = function (t, e) {
          ...
          return (n = (n = (n = (n = (n = n.concat(i.errors)).concat(
            (function (t) {
              ...
              return (e = (e = (e = (e = (e = e.concat(E(n))).concat(
                T(n)
              )).concat(v(n))).concat(g(n))).concat(m(n)));
            })(o)
        ...
        var e = [],
          n = u.map(t, function (n) {
            return u.reduce(
              t,
              function (t, r) {
                return n.PATTERN.source !== r.PATTERN.source ||
                  u.contains(e, r) ||
                  r.PATTERN === s.Lexer.NA
                  ? t
                  : (e.push(r), t.push(r), t);
              },
              []
      ...
      function L(t, e) {
        ...
        if (S(t))
          return { issue: s.LexerDefinitionErrorType.CUSTOM_LINE_BREAK };
        throw Error("non exhaustive match");
      }
      function k(t, e) {
      ...
      (e.findStartOfInputAnchor = T),
          ...
          return (
            u.has(t, e.DEFAULT_MODE) ||
              i.push({
                ...
                type: s.LexerDefinitionErrorType
                  .MULTI_MODE_LEXER_WITHOUT_DEFAULT_MODE,
              }),
            u.has(t, e.MODES) ||
              i.push({
            ...
            u.has(t, e.MODES) &&
              u.forEach(t.modes, function (t, e) {
        ...
        (e.performWarningRuntimeChecks = function (t, e, n) {
          var r = [],
            ...
            o = u.compact(
              u.flatten(
                u.mapValues(t.modes, function (t) {
                  return t;
                })
              )
            ),
          ...
          return (
            e &&
              u.forEach(a, function (t) {
                var e = L(t, p);
                if (!1 !== e) {
                  var n = { message: k(t, e), type: e.issue, tokenType: t };
                  r.push(n);
          ...
          case "Alternative":
            for (var e = [], n = t.value, r = 0; r < n.length; r++) {
              ...
              if (
                  ...
                  case "Set":
                    ...
                    a.forEach(o.value, function (t) {
                      if ("number" == typeof t) e.push(t);
                        ...
                        for (var n = t, r = n.from; r <= n.to; r++) e.push(r);
                    });
                    break;
                  case "Group":
                    var s = c(o.value);
                ...
                var p = void 0 !== o.quantifier && 0 === o.quantifier.atLeast;
                if (
                  ("Group" === o.type && !1 === h(o)) ||
                  ("Group" !== o.type && !1 === p)
                )
    ...
    function (t, e, n) {
      ...
      var r = (function () {
        function t(t, e) {
          if (((this.start = t), (this.end = e), !i(t, e)))
    ...
    function (t, e, n) {
      ...
      var u = (function (t) {
        function e(e, n) {
          var r = t.call(this) || this;
          return (
            (r.nameToTopRule = e), (r.errMsgProvider = n), (r.errors = []), r
          );
        }
        return (
          i(e, t),
          ...
          return (
            (t.prototype.initLooksAhead = function (t) {
              (this.dynamicTokensEnabled = i.has(t, "dynamicTokensEnabled")
                ...
                (this.maxLookahead = i.has(t, "maxLookahead")
                  ? t.maxLookahead
                  : o.DEFAULT_PARSER_CONFIG.maxLookahead),
                (this.lookAheadFuncsCache = i.isES2015MapSupported()
                  ? new Map()
                  : []),
            ...
            (t.prototype.lookAheadBuilderForAlternatives = function (
              t,
              e,
              n,
              i
            ...
            (t.prototype.getLookaheadFuncForManySep = function (t, e) {
              return this.getLookaheadFuncFor(
                ...
                e,
                this.maxLookahead,
                r.PROD_TYPE.REPETITION_WITH_SEPARATOR
              );
            }),
            (t.prototype.getLookaheadFuncForAtLeastOne = function (t, e) {
              return this.getLookaheadFuncFor(
                ...
                e,
                this.maxLookahead,
                r.PROD_TYPE.REPETITION_MANDATORY
              );
            }),
            (t.prototype.getLookaheadFuncForAtLeastOneSep = function (t, e) {
              return this.getLookaheadFuncFor(
                ...
                e,
                this.maxLookahead,
                r.PROD_TYPE.REPETITION_MANDATORY_WITH_SEPARATOR
              );
            }),
            (t.prototype.getLookaheadFuncFor = function (t, e, n, i) {
              var o = this.getLaFuncFromCache(t);
              if (void 0 === o) {
          ...
          return (
            (t.prototype.initTreeBuilder = function (t) {
              (this.LAST_EXPLICIT_RULE_STACK = []),
                (this.CST_STACK = []),
                (this.outputCst = i.has(t, "outputCst")
                  ? t.outputCst
                  : s.DEFAULT_PARSER_CONFIG.outputCst),
                this.outputCst ||
            ...
            (t.prototype.getBaseCstVisitorConstructor = function () {
              if (i.isUndefined(this.baseCstVisitorConstructor)) {
                var t = o.createBaseSemanticVisitorConstructor(
                  this.className,
                  this.allRuleNames
                );
            ...
            (t.prototype.getBaseCstVisitorConstructorWithDefaults =
              function () {
            ...
            (t.prototype.nestedRuleBeforeClause = function (t, e) {
              ...
              return void 0 !== t.NAME
                ? ((n = t.NAME), this.nestedRuleInvocationStateUpdate(n, e), n)
                : void 0;
            }),
            (t.prototype.nestedAltBeforeClause = function (t, e, n, r) {
              var i,
                o = this.getLastExplicitRuleShortName(),
                s = a.getKeyForAltIndex(o, n, e, r);
              return void 0 !== t.NAME
                ? ((i = t.NAME),
                  this.nestedRuleInvocationStateUpdate(i, s),
                  { shortName: s, nestedName: i })
                : void 0;
            }),
            ...
            (t.prototype.nestedRuleInvocationStateUpdate = function (t, e) {
              this.RULE_OCCURRENCE_STACK.push(1),
                ...
                this.cstNestedInvocationStateUpdate(t, e);
            }),
    ...
    function (t, e, n) {
      ...
      function s(t, e) {
        for (var n = i.keys(t), r = n.length, o = 0; o < r; o++)
          for (var a = t[n[o]], s = a.length, u = 0; u < s; u++) {
            var c = a[u];
            void 0 === c.tokenTypeIdx &&
              (void 0 !== c.fullName
                ? this[c.fullName](c.children, e)
                : this[c.name](c.children, e));
          }
      }
      function u(t, e) {
        var n = c(t, e),
      ...
      (e.defaultVisit = s),
            ...
            ((n.prototype = {
              visit: function (t, e) {
                if ((i.isArray(t) && (t = t[0]), !i.isUndefined(t)))
                  return void 0 !== t.fullName
                    ? this[t.fullName](t.children, e)
                    : this[t.name](t.children, e);
              },
        ...
        (function (t) {
          ...
          (r =
            e.CstVisitorDefinitionError || (e.CstVisitorDefinitionError = {}))
        ),
        (e.validateVisitor = u),
        ...
        i = (function () {
          ...
          return (
            ...
            (t.prototype.LA = function (t) {
              return this.currIdx + t < 0 ||
                this.tokVectorLength <= this.currIdx + t
                ? r.END_OF_FILE
          ...
          return (
            ...
            (t.prototype.RULE = function (t, e, n) {
              if (
                ...
                r.contains(this.definedRulesNames, t))
              ) {
                var i = {
                  message:
                    a.defaultGrammarValidatorErrorProvider.buildDuplicateRuleNameError(
                      { topLevelRule: t, grammarName: this.className }
                    ),
              ...
              if (
                ...
                !this.gastProductionsCache.containsKey(t) &&
                  !this.serializedGrammar)
              ) {
                var u = s.buildTopProduction(e.toString(), t, this.tokensMap);
            ...
            (t.prototype.OVERRIDE_RULE = function (t, e, n) {
              ...
              if (
                ...
                var i = s.buildTopProduction(e.toString(), t, this.tokensMap);
          ...
          return (
            (t.prototype.initRecognizerEngine = function (t, e) {
              ...
              if (r.isArray(t))
                ...
                r.has(t, "modes") &&
                r.every(r.flatten(r.values(t.modes)), l.isTokenType)
              ) {
            ...
            (t.prototype.defineRule = function (t, e, n) {
              ...
              var a,
                s = r.has(n, "resyncEnabled")
                  ? n.resyncEnabled
                  : u.DEFAULT_RULE_CONFIG.resyncEnabled,
                c = r.has(n, "recoveryValueFunc")
                  ? n.recoveryValueFunc
                  : u.DEFAULT_RULE_CONFIG.recoveryValueFunc,
                p =
                  this.ruleShortNameIdx <<
                  (i.BITS_FOR_METHOD_IDX + i.BITS_FOR_OCCURRENCE_IDX);
              this.ruleShortNameIdx++,
                this.shortRuleNameToFull.put(p, t),
                this.fullRuleNameToShort.put(t, p);
              return (
                ((a = function (n, r) {
                  return (
                    void 0 === n && (n = 0),
                    ...
                    function (t) {
                      try {
                        ...
                        var n = 1 === this.RULE_STACK.length,
                          r =
                            s && !this.isBackTracking() && this.recoveryEnabled;
            ...
            (t.prototype.atLeastOneInternalLogic = function (t, e, n) {
              var r,
                o,
                u = this,
                c = this.getLookaheadFuncForAtLeastOne(n, t);
              if (void 0 !== e.DEF) {
              ...
              if (!0 !== c.call(this))
                throw this.raiseEarlyExitException(
                  t,
                  a.PROD_TYPE.REPETITION_MANDATORY,
                  e.ERR_MSG
                );
              for (
            ...
            (t.prototype.atLeastOneSepFirstInternal = function (t, e) {
              var n = this.getKeyForAutomaticLookahead(
            ...
            (t.prototype.atLeastOneSepFirstInternalLogic = function (t, e, n) {
              ...
              if (!0 !== this.getLookaheadFuncForAtLeastOneSep(n, t).call(this))
                throw this.raiseEarlyExitException(
                  t,
                  a.PROD_TYPE.REPETITION_MANDATORY_WITH_SEPARATOR,
                  e.ERR_MSG
                );
              o.call(this);
              for (
                ...
                !0 === this.tokenMatcher(this.LA(1), u);
            ...
            (t.prototype.manyInternalLogic = function (t, e, n) {
              var r,
                o,
                a = this,
                u = this.getLookaheadFuncForMany(n, t);
              if (void 0 !== e.DEF) {
                if (((r = e.DEF), void 0 !== (o = e.GATE))) {
                  var c = u;
                  u = function () {
              ...
              for (var p = !0; !0 === u.call(this) && !0 === p; )
                p = this.doSingleRepetition(r);
              this.attemptInRepetitionRecovery(
                this.manyInternal,
                [t, e],
                u,
            ...
            (t.prototype.repetitionSepSecondInternal = function (
              t,
              e,
              n,
              r,
              ...
              try {
                ...
                if (void 0 !== s) {
                  ...
                  try {
                    ...
                    void 0 !== c &&
                      this.nestedRuleFinallyClause(c.shortName, c.nestedName);
                  }
                }
                this.raiseNoAltException(e, t.ERR_MSG);
              } finally {
            ...
            (t.prototype.consumeInternal = function (t, e, n) {
              ...
              try {
                ...
                if (
                  ...
                  throw n;
                var u = this.getFollowsForInRuleRecovery(t, e);
                try {
              ...
              return (
                this.cstPostTerminal(
                  void 0 !== n && void 0 !== n.LABEL ? n.LABEL : t.tokenName,
                  r
                ),
                r
              );
            ...
            (t.prototype.ruleInvocationStateUpdate = function (t, e, n) {
              this.RULE_OCCURRENCE_STACK.push(n),
                ...
                this.cstInvocationStateUpdate(e, t);
            }),
        ...
        s = (function () {
          ...
          return (
            ...
            (t.prototype.raiseEarlyExitException = function (t, e, n) {
              for (
                var i = this.getCurrRuleFullName(),
                  ...
                  s = o.getLookaheadPathsForOptionalProd(
                    t,
                    a,
                    e,
                    this.maxLookahead
            ...
            (t.prototype.raiseNoAltException = function (t, e) {
              ...
              throw this.SAVE_ERROR(
                new r.NoViableAltException(p, this.LA(1), c)
              );
            }),
            t
          );
        ...
        o = (function () {
          ...
          return (
            ...
            (t.prototype.computeContentAssist = function (t, e) {
              ...
              if (i.isUndefined(n))
                throw Error(
                  "Rule ->" + t + "<- does not exist in this grammar."
                );
              return r.nextPossibleTokensAfter(
                [n],
                e,
                this.tokenMatcher,
                this.maxLookahead
    ...
    function (t, e, n) {
      ...
      e.createSyntaxDiagramsCode = function (t, e) {
        var n = void 0 === e ? {} : e,
          ...
          o =
            void 0 === i
              ? "https://unpkg.com/chevrotain@" + r.VERSION + "/diagrams/"
              : i,
          a = n.css;
        return (
    ...
    function (t, e, n) {
      ...
      function c(t, e) {
        var n = y(e, '$.RULE("' + t.name + '", function() {') + a;
        ...
        return (
          e.name || e.separator
            ? ((r += "{" + a),
              ...
              e.separator &&
                (r +=
                  y(n + 1, "SEP: this.tokensMap." + i.tokenName(e.separator)) +
                  "," +
                  a),
        ...
        return (
          r.forEach(t, function (t) {
            n += (function (t, e) {
              ...
              if (t instanceof o.RepetitionMandatory)
                return d("AT_LEAST_ONE", t, e);
              if (t instanceof o.RepetitionMandatoryWithSeparator)
                return d("AT_LEAST_ONE_SEP", t, e);
              if (t instanceof o.RepetitionWithSeparator)
                return d("MANY_SEP", t, e);
