...
K.prototype.b = function (f, d, c) {
  ...
  if (8 > d + a) (g = (g << d) | f), (a += d);
    ...
    for (m = 0; m < d; ++m)
      (g = (g << 1) | ((f >> (d - m - 1)) & 1)),
        8 === ++a &&
          ((a = 0), (e[b++] = L[g]), (g = 0), b === e.length && (e = ca(this)));
  e[b] = g;
  this.buffer = e;
  this.e = a;
  this.index = b;
...
function oa(f, d) {
  ...
  for (b = d.length; e < b; ++e) {
    a = m = 0;
    for (g = 3; a < g && e + a !== b; ++a) m = (m << 8) | d[e + a];
    k[m] === n && (k[m] = []);
    p = k[m];
    if (!(0 < q--)) {
      ...
      if (e + 3 >= b) {
        u && c(u, -1);
        a = 0;
        for (g = b - e; a < g; ++a) (z = d[e + a]), (l[h++] = z), ++s[z];
        break;
      }
      0 < p.length
        ? ((t = Ia(d, e, p)),
...
function Ia(f, d, c) {
  ...
  a: for (; m < p; m++) {
    ...
    g = 3;
    if (3 < a) {
      for (k = a; 3 < k; k--) if (f[e + k - 1] !== f[d + k - 1]) continue a;
      g = a;
    }
    for (; 258 > g && d + g < t && f[e + g] === f[d + g]; ) ++g;
    g > a && ((b = e), (a = g));
    if (258 === g) break;
  }
  return new ra(a, d - b);
